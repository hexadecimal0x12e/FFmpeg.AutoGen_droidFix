...
public static unsafe partial class DynamicallyLinkedBindings
{
    ...
    [DllImport("avutil-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avcodec-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avfilter-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avformat-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avdevice-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("swresample-0", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("swscale-0", CallingConvention = CallingConvention.Cdecl)]
