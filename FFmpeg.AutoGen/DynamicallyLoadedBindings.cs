...
namespace FFmpeg.AutoGen
{
    ...
    public static partial class DynamicallyLoadedBindings
    {
        ...
        /// </summary>
        public static bool EnableAutoInitialization { get; set; } = false;
        ...
        public static bool ValidateLibraryVersion()
        {
            ...
            {
                var versionInfoDelegate = FunctionResolver.GetFunctionDelegate<vectors.av_version_info_delegate>("avutil", "av_version_info");
        ...
        private static uint GetLibraryVersionInt(string libraryName)
        {
            ...
            {
                "avcodec" => FunctionResolver.GetFunctionDelegate<vectors.avcodec_version_delegate>("avcodec", "avcodec_version")(),
                "avdevice" => FunctionResolver.GetFunctionDelegate<vectors.avdevice_version_delegate>("avdevice", "avdevice_version")(),
                "avfilter" => FunctionResolver.GetFunctionDelegate<vectors.avfilter_version_delegate>("avfilter", "avfilter_version")(),
                "avformat" => FunctionResolver.GetFunctionDelegate<vectors.avformat_version_delegate>("avformat", "avformat_version")(),
                "avutil" => FunctionResolver.GetFunctionDelegate<vectors.avutil_version_delegate>("avutil", "avutil_version")(),
                "swresample" => FunctionResolver.GetFunctionDelegate<vectors.swresample_version_delegate>("swresample", "swresample_version")(),
                "swscale" => FunctionResolver.GetFunctionDelegate<vectors.swscale_version_delegate>("swscale", "swscale_version")(),
