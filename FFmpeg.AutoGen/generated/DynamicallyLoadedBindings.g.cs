...
public static unsafe partial class DynamicallyLoadedBindings
{
    ...
    public unsafe static void Initialize()
    {
        ...
        vectors.av_add_q = (AVRational @b, AVRational @c) =>
        {
            ...
            vectors.av_add_q = av_add_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_add_q_delegate>(av_add_q_ptr);
        ...
        vectors.av_add_stable = (AVRational @ts_tb, long @ts, AVRational @inc_tb, long @inc) =>
        {
            ...
            vectors.av_add_stable = av_add_stable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_add_stable_delegate>(av_add_stable_ptr);
        ...
        vectors.av_audio_fifo_alloc = (AVSampleFormat @sample_fmt, int @channels, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_alloc = av_audio_fifo_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_alloc_delegate>(av_audio_fifo_alloc_ptr);
        ...
        vectors.av_audio_fifo_drain = (AVAudioFifo* @af, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_drain = av_audio_fifo_drain_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_drain_delegate>(av_audio_fifo_drain_ptr);
        ...
        vectors.av_audio_fifo_free = (AVAudioFifo* @af) =>
        {
            ...
            vectors.av_audio_fifo_free = av_audio_fifo_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_free_delegate>(av_audio_fifo_free_ptr);
        ...
        vectors.av_audio_fifo_peek = (AVAudioFifo* @af, void** @data, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_peek = av_audio_fifo_peek_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_peek_delegate>(av_audio_fifo_peek_ptr);
        ...
        vectors.av_audio_fifo_peek_at = (AVAudioFifo* @af, void** @data, int @nb_samples, int @offset) =>
        {
            ...
            vectors.av_audio_fifo_peek_at = av_audio_fifo_peek_at_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_peek_at_delegate>(av_audio_fifo_peek_at_ptr);
        ...
        vectors.av_audio_fifo_read = (AVAudioFifo* @af, void** @data, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_read = av_audio_fifo_read_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_read_delegate>(av_audio_fifo_read_ptr);
        ...
        vectors.av_audio_fifo_realloc = (AVAudioFifo* @af, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_realloc = av_audio_fifo_realloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_realloc_delegate>(av_audio_fifo_realloc_ptr);
        ...
        vectors.av_audio_fifo_reset = (AVAudioFifo* @af) =>
        {
            ...
            vectors.av_audio_fifo_reset = av_audio_fifo_reset_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_reset_delegate>(av_audio_fifo_reset_ptr);
        ...
        vectors.av_audio_fifo_size = (AVAudioFifo* @af) =>
        {
            ...
            vectors.av_audio_fifo_size = av_audio_fifo_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_size_delegate>(av_audio_fifo_size_ptr);
        ...
        vectors.av_audio_fifo_space = (AVAudioFifo* @af) =>
        {
            ...
            vectors.av_audio_fifo_space = av_audio_fifo_space_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_space_delegate>(av_audio_fifo_space_ptr);
        ...
        vectors.av_audio_fifo_write = (AVAudioFifo* @af, void** @data, int @nb_samples) =>
        {
            ...
            vectors.av_audio_fifo_write = av_audio_fifo_write_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_audio_fifo_write_delegate>(av_audio_fifo_write_ptr);
        ...
        vectors.av_bessel_i0 = (double @x) =>
        {
            ...
            vectors.av_bessel_i0 = av_bessel_i0_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bessel_i0_delegate>(av_bessel_i0_ptr);
        ...
        vectors.av_bsf_alloc = (AVBitStreamFilter* @filter, AVBSFContext** @ctx) =>
        {
            ...
            vectors.av_bsf_alloc = av_bsf_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_alloc_delegate>(av_bsf_alloc_ptr);
        ...
        vectors.av_bsf_flush = (AVBSFContext* @ctx) =>
        {
            ...
            vectors.av_bsf_flush = av_bsf_flush_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_flush_delegate>(av_bsf_flush_ptr);
        ...
        vectors.av_bsf_free = (AVBSFContext** @ctx) =>
        {
            ...
            vectors.av_bsf_free = av_bsf_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_free_delegate>(av_bsf_free_ptr);
        ...
        vectors.av_bsf_get_by_name = (string @name) =>
        {
            ...
            vectors.av_bsf_get_by_name = av_bsf_get_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_get_by_name_delegate>(av_bsf_get_by_name_ptr);
        ...
        vectors.av_bsf_get_class = () =>
        {
            ...
            vectors.av_bsf_get_class = av_bsf_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_get_class_delegate>(av_bsf_get_class_ptr);
        ...
        vectors.av_bsf_get_null_filter = (AVBSFContext** @bsf) =>
        {
            ...
            vectors.av_bsf_get_null_filter = av_bsf_get_null_filter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_get_null_filter_delegate>(av_bsf_get_null_filter_ptr);
        ...
        vectors.av_bsf_init = (AVBSFContext* @ctx) =>
        {
            ...
            vectors.av_bsf_init = av_bsf_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_init_delegate>(av_bsf_init_ptr);
        ...
        vectors.av_bsf_iterate = (void** @opaque) =>
        {
            ...
            vectors.av_bsf_iterate = av_bsf_iterate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_iterate_delegate>(av_bsf_iterate_ptr);
        ...
        vectors.av_bsf_list_alloc = () =>
        {
            ...
            vectors.av_bsf_list_alloc = av_bsf_list_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_alloc_delegate>(av_bsf_list_alloc_ptr);
        ...
        vectors.av_bsf_list_append = (AVBSFList* @lst, AVBSFContext* @bsf) =>
        {
            ...
            vectors.av_bsf_list_append = av_bsf_list_append_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_append_delegate>(av_bsf_list_append_ptr);
        ...
        vectors.av_bsf_list_append2 = (AVBSFList* @lst, string @bsf_name, AVDictionary** @options) =>
        {
            ...
            vectors.av_bsf_list_append2 = av_bsf_list_append2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_append2_delegate>(av_bsf_list_append2_ptr);
        ...
        vectors.av_bsf_list_finalize = (AVBSFList** @lst, AVBSFContext** @bsf) =>
        {
            ...
            vectors.av_bsf_list_finalize = av_bsf_list_finalize_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_finalize_delegate>(av_bsf_list_finalize_ptr);
        ...
        vectors.av_bsf_list_free = (AVBSFList** @lst) =>
        {
            ...
            vectors.av_bsf_list_free = av_bsf_list_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_free_delegate>(av_bsf_list_free_ptr);
        ...
        vectors.av_bsf_list_parse_str = (string @str, AVBSFContext** @bsf) =>
        {
            ...
            vectors.av_bsf_list_parse_str = av_bsf_list_parse_str_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_list_parse_str_delegate>(av_bsf_list_parse_str_ptr);
        ...
        vectors.av_bsf_receive_packet = (AVBSFContext* @ctx, AVPacket* @pkt) =>
        {
            ...
            vectors.av_bsf_receive_packet = av_bsf_receive_packet_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_receive_packet_delegate>(av_bsf_receive_packet_ptr);
        ...
        vectors.av_bsf_send_packet = (AVBSFContext* @ctx, AVPacket* @pkt) =>
        {
            ...
            vectors.av_bsf_send_packet = av_bsf_send_packet_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_bsf_send_packet_delegate>(av_bsf_send_packet_ptr);
        ...
        vectors.av_buffer_alloc = (ulong @size) =>
        {
            ...
            vectors.av_buffer_alloc = av_buffer_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_alloc_delegate>(av_buffer_alloc_ptr);
        ...
        vectors.av_buffer_allocz = (ulong @size) =>
        {
            ...
            vectors.av_buffer_allocz = av_buffer_allocz_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_allocz_delegate>(av_buffer_allocz_ptr);
        ...
        vectors.av_buffer_create = (byte* @data, ulong @size, av_buffer_create_free_func @free, void* @opaque, int @flags) =>
        {
            ...
            vectors.av_buffer_create = av_buffer_create_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_create_delegate>(av_buffer_create_ptr);
        ...
        vectors.av_buffer_default_free = (void* @opaque, byte* @data) =>
        {
            ...
            vectors.av_buffer_default_free = av_buffer_default_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_default_free_delegate>(av_buffer_default_free_ptr);
        ...
        vectors.av_buffer_get_opaque = (AVBufferRef* @buf) =>
        {
            ...
            vectors.av_buffer_get_opaque = av_buffer_get_opaque_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_get_opaque_delegate>(av_buffer_get_opaque_ptr);
        ...
        vectors.av_buffer_get_ref_count = (AVBufferRef* @buf) =>
        {
            ...
            vectors.av_buffer_get_ref_count = av_buffer_get_ref_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_get_ref_count_delegate>(av_buffer_get_ref_count_ptr);
        ...
        vectors.av_buffer_is_writable = (AVBufferRef* @buf) =>
        {
            ...
            vectors.av_buffer_is_writable = av_buffer_is_writable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_is_writable_delegate>(av_buffer_is_writable_ptr);
        ...
        vectors.av_buffer_make_writable = (AVBufferRef** @buf) =>
        {
            ...
            vectors.av_buffer_make_writable = av_buffer_make_writable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_make_writable_delegate>(av_buffer_make_writable_ptr);
        ...
        vectors.av_buffer_pool_buffer_get_opaque = (AVBufferRef* @ref) =>
        {
            ...
            vectors.av_buffer_pool_buffer_get_opaque = av_buffer_pool_buffer_get_opaque_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_pool_buffer_get_opaque_delegate>(av_buffer_pool_buffer_get_opaque_ptr);
        ...
        vectors.av_buffer_pool_get = (AVBufferPool* @pool) =>
        {
            ...
            vectors.av_buffer_pool_get = av_buffer_pool_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_pool_get_delegate>(av_buffer_pool_get_ptr);
        ...
        vectors.av_buffer_pool_init = (ulong @size, av_buffer_pool_init_alloc_func @alloc) =>
        {
            ...
            vectors.av_buffer_pool_init = av_buffer_pool_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_pool_init_delegate>(av_buffer_pool_init_ptr);
        ...
        vectors.av_buffer_pool_init2 = (ulong @size, void* @opaque, av_buffer_pool_init2_alloc_func @alloc, av_buffer_pool_init2_pool_free_func @pool_free) =>
        {
            ...
            vectors.av_buffer_pool_init2 = av_buffer_pool_init2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_pool_init2_delegate>(av_buffer_pool_init2_ptr);
        ...
        vectors.av_buffer_pool_uninit = (AVBufferPool** @pool) =>
        {
            ...
            vectors.av_buffer_pool_uninit = av_buffer_pool_uninit_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_pool_uninit_delegate>(av_buffer_pool_uninit_ptr);
        ...
        vectors.av_buffer_realloc = (AVBufferRef** @buf, ulong @size) =>
        {
            ...
            vectors.av_buffer_realloc = av_buffer_realloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_realloc_delegate>(av_buffer_realloc_ptr);
        ...
        vectors.av_buffer_ref = (AVBufferRef* @buf) =>
        {
            ...
            vectors.av_buffer_ref = av_buffer_ref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_ref_delegate>(av_buffer_ref_ptr);
        ...
        vectors.av_buffer_replace = (AVBufferRef** @dst, AVBufferRef* @src) =>
        {
            ...
            vectors.av_buffer_replace = av_buffer_replace_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_replace_delegate>(av_buffer_replace_ptr);
        ...
        vectors.av_buffer_unref = (AVBufferRef** @buf) =>
        {
            ...
            vectors.av_buffer_unref = av_buffer_unref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffer_unref_delegate>(av_buffer_unref_ptr);
        ...
        vectors.av_buffersink_get_ch_layout = (AVFilterContext* @ctx, AVChannelLayout* @ch_layout) =>
        {
            ...
            vectors.av_buffersink_get_ch_layout = av_buffersink_get_ch_layout_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_ch_layout_delegate>(av_buffersink_get_ch_layout_ptr);
        ...
        vectors.av_buffersink_get_channels = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_channels = av_buffersink_get_channels_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_channels_delegate>(av_buffersink_get_channels_ptr);
        ...
        vectors.av_buffersink_get_color_range = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_color_range = av_buffersink_get_color_range_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_color_range_delegate>(av_buffersink_get_color_range_ptr);
        ...
        vectors.av_buffersink_get_colorspace = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_colorspace = av_buffersink_get_colorspace_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_colorspace_delegate>(av_buffersink_get_colorspace_ptr);
        ...
        vectors.av_buffersink_get_format = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_format = av_buffersink_get_format_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_format_delegate>(av_buffersink_get_format_ptr);
        ...
        vectors.av_buffersink_get_frame = (AVFilterContext* @ctx, AVFrame* @frame) =>
        {
            ...
            vectors.av_buffersink_get_frame = av_buffersink_get_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_frame_delegate>(av_buffersink_get_frame_ptr);
        ...
        vectors.av_buffersink_get_frame_flags = (AVFilterContext* @ctx, AVFrame* @frame, int @flags) =>
        {
            ...
            vectors.av_buffersink_get_frame_flags = av_buffersink_get_frame_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_frame_flags_delegate>(av_buffersink_get_frame_flags_ptr);
        ...
        vectors.av_buffersink_get_frame_rate = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_frame_rate = av_buffersink_get_frame_rate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_frame_rate_delegate>(av_buffersink_get_frame_rate_ptr);
        ...
        vectors.av_buffersink_get_h = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_h = av_buffersink_get_h_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_h_delegate>(av_buffersink_get_h_ptr);
        ...
        vectors.av_buffersink_get_hw_frames_ctx = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_hw_frames_ctx = av_buffersink_get_hw_frames_ctx_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_hw_frames_ctx_delegate>(av_buffersink_get_hw_frames_ctx_ptr);
        ...
        vectors.av_buffersink_get_sample_aspect_ratio = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_sample_aspect_ratio = av_buffersink_get_sample_aspect_ratio_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_sample_aspect_ratio_delegate>(av_buffersink_get_sample_aspect_ratio_ptr);
        ...
        vectors.av_buffersink_get_sample_rate = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_sample_rate = av_buffersink_get_sample_rate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_sample_rate_delegate>(av_buffersink_get_sample_rate_ptr);
        ...
        vectors.av_buffersink_get_samples = (AVFilterContext* @ctx, AVFrame* @frame, int @nb_samples) =>
        {
            ...
            vectors.av_buffersink_get_samples = av_buffersink_get_samples_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_samples_delegate>(av_buffersink_get_samples_ptr);
        ...
        vectors.av_buffersink_get_side_data = (AVFilterContext* @ctx, int* @nb_side_data) =>
        {
            ...
            vectors.av_buffersink_get_side_data = av_buffersink_get_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_side_data_delegate>(av_buffersink_get_side_data_ptr);
        ...
        vectors.av_buffersink_get_time_base = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_time_base = av_buffersink_get_time_base_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_time_base_delegate>(av_buffersink_get_time_base_ptr);
        ...
        vectors.av_buffersink_get_type = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_type = av_buffersink_get_type_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_type_delegate>(av_buffersink_get_type_ptr);
        ...
        vectors.av_buffersink_get_w = (AVFilterContext* @ctx) =>
        {
            ...
            vectors.av_buffersink_get_w = av_buffersink_get_w_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_get_w_delegate>(av_buffersink_get_w_ptr);
        ...
        vectors.av_buffersink_set_frame_size = (AVFilterContext* @ctx, uint @frame_size) =>
        {
            ...
            vectors.av_buffersink_set_frame_size = av_buffersink_set_frame_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersink_set_frame_size_delegate>(av_buffersink_set_frame_size_ptr);
        ...
        vectors.av_buffersrc_add_frame = (AVFilterContext* @ctx, AVFrame* @frame) =>
        {
            ...
            vectors.av_buffersrc_add_frame = av_buffersrc_add_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_add_frame_delegate>(av_buffersrc_add_frame_ptr);
        ...
        vectors.av_buffersrc_add_frame_flags = (AVFilterContext* @buffer_src, AVFrame* @frame, int @flags) =>
        {
            ...
            vectors.av_buffersrc_add_frame_flags = av_buffersrc_add_frame_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_add_frame_flags_delegate>(av_buffersrc_add_frame_flags_ptr);
        ...
        vectors.av_buffersrc_close = (AVFilterContext* @ctx, long @pts, uint @flags) =>
        {
            ...
            vectors.av_buffersrc_close = av_buffersrc_close_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_close_delegate>(av_buffersrc_close_ptr);
        ...
        vectors.av_buffersrc_get_nb_failed_requests = (AVFilterContext* @buffer_src) =>
        {
            ...
            vectors.av_buffersrc_get_nb_failed_requests = av_buffersrc_get_nb_failed_requests_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_get_nb_failed_requests_delegate>(av_buffersrc_get_nb_failed_requests_ptr);
        ...
        vectors.av_buffersrc_parameters_alloc = () =>
        {
            ...
            vectors.av_buffersrc_parameters_alloc = av_buffersrc_parameters_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_parameters_alloc_delegate>(av_buffersrc_parameters_alloc_ptr);
        ...
        vectors.av_buffersrc_parameters_set = (AVFilterContext* @ctx, AVBufferSrcParameters* @param) =>
        {
            ...
            vectors.av_buffersrc_parameters_set = av_buffersrc_parameters_set_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_parameters_set_delegate>(av_buffersrc_parameters_set_ptr);
        ...
        vectors.av_buffersrc_write_frame = (AVFilterContext* @ctx, AVFrame* @frame) =>
        {
            ...
            vectors.av_buffersrc_write_frame = av_buffersrc_write_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_buffersrc_write_frame_delegate>(av_buffersrc_write_frame_ptr);
        ...
        vectors.av_calloc = (ulong @nmemb, ulong @size) =>
        {
            ...
            vectors.av_calloc = av_calloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_calloc_delegate>(av_calloc_ptr);
        ...
        vectors.av_channel_description = (byte* @buf, ulong @buf_size, AVChannel @channel) =>
        {
            ...
            vectors.av_channel_description = av_channel_description_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_description_delegate>(av_channel_description_ptr);
        ...
        vectors.av_channel_description_bprint = (AVBPrint* @bp, AVChannel @channel_id) =>
        {
            ...
            vectors.av_channel_description_bprint = av_channel_description_bprint_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_description_bprint_delegate>(av_channel_description_bprint_ptr);
        ...
        vectors.av_channel_from_string = (string @name) =>
        {
            ...
            vectors.av_channel_from_string = av_channel_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_from_string_delegate>(av_channel_from_string_ptr);
        ...
        vectors.av_channel_layout_ambisonic_order = (AVChannelLayout* @channel_layout) =>
        {
            ...
            vectors.av_channel_layout_ambisonic_order = av_channel_layout_ambisonic_order_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_ambisonic_order_delegate>(av_channel_layout_ambisonic_order_ptr);
        ...
        vectors.av_channel_layout_channel_from_index = (AVChannelLayout* @channel_layout, uint @idx) =>
        {
            ...
            vectors.av_channel_layout_channel_from_index = av_channel_layout_channel_from_index_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_channel_from_index_delegate>(av_channel_layout_channel_from_index_ptr);
        ...
        vectors.av_channel_layout_channel_from_string = (AVChannelLayout* @channel_layout, string @name) =>
        {
            ...
            vectors.av_channel_layout_channel_from_string = av_channel_layout_channel_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_channel_from_string_delegate>(av_channel_layout_channel_from_string_ptr);
        ...
        vectors.av_channel_layout_check = (AVChannelLayout* @channel_layout) =>
        {
            ...
            vectors.av_channel_layout_check = av_channel_layout_check_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_check_delegate>(av_channel_layout_check_ptr);
        ...
        vectors.av_channel_layout_compare = (AVChannelLayout* @chl, AVChannelLayout* @chl1) =>
        {
            ...
            vectors.av_channel_layout_compare = av_channel_layout_compare_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_compare_delegate>(av_channel_layout_compare_ptr);
        ...
        vectors.av_channel_layout_copy = (AVChannelLayout* @dst, AVChannelLayout* @src) =>
        {
            ...
            vectors.av_channel_layout_copy = av_channel_layout_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_copy_delegate>(av_channel_layout_copy_ptr);
        ...
        vectors.av_channel_layout_custom_init = (AVChannelLayout* @channel_layout, int @nb_channels) =>
        {
            ...
            vectors.av_channel_layout_custom_init = av_channel_layout_custom_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_custom_init_delegate>(av_channel_layout_custom_init_ptr);
        ...
        vectors.av_channel_layout_default = (AVChannelLayout* @ch_layout, int @nb_channels) =>
        {
            ...
            vectors.av_channel_layout_default = av_channel_layout_default_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_default_delegate>(av_channel_layout_default_ptr);
        ...
        vectors.av_channel_layout_describe = (AVChannelLayout* @channel_layout, byte* @buf, ulong @buf_size) =>
        {
            ...
            vectors.av_channel_layout_describe = av_channel_layout_describe_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_describe_delegate>(av_channel_layout_describe_ptr);
        ...
        vectors.av_channel_layout_describe_bprint = (AVChannelLayout* @channel_layout, AVBPrint* @bp) =>
        {
            ...
            vectors.av_channel_layout_describe_bprint = av_channel_layout_describe_bprint_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_describe_bprint_delegate>(av_channel_layout_describe_bprint_ptr);
        ...
        vectors.av_channel_layout_from_mask = (AVChannelLayout* @channel_layout, ulong @mask) =>
        {
            ...
            vectors.av_channel_layout_from_mask = av_channel_layout_from_mask_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_from_mask_delegate>(av_channel_layout_from_mask_ptr);
        ...
        vectors.av_channel_layout_from_string = (AVChannelLayout* @channel_layout, string @str) =>
        {
            ...
            vectors.av_channel_layout_from_string = av_channel_layout_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_from_string_delegate>(av_channel_layout_from_string_ptr);
        ...
        vectors.av_channel_layout_index_from_channel = (AVChannelLayout* @channel_layout, AVChannel @channel) =>
        {
            ...
            vectors.av_channel_layout_index_from_channel = av_channel_layout_index_from_channel_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_index_from_channel_delegate>(av_channel_layout_index_from_channel_ptr);
        ...
        vectors.av_channel_layout_index_from_string = (AVChannelLayout* @channel_layout, string @name) =>
        {
            ...
            vectors.av_channel_layout_index_from_string = av_channel_layout_index_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_index_from_string_delegate>(av_channel_layout_index_from_string_ptr);
        ...
        vectors.av_channel_layout_retype = (AVChannelLayout* @channel_layout, AVChannelOrder @order, int @flags) =>
        {
            ...
            vectors.av_channel_layout_retype = av_channel_layout_retype_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_retype_delegate>(av_channel_layout_retype_ptr);
        ...
        vectors.av_channel_layout_standard = (void** @opaque) =>
        {
            ...
            vectors.av_channel_layout_standard = av_channel_layout_standard_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_standard_delegate>(av_channel_layout_standard_ptr);
        ...
        vectors.av_channel_layout_subset = (AVChannelLayout* @channel_layout, ulong @mask) =>
        {
            ...
            vectors.av_channel_layout_subset = av_channel_layout_subset_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_subset_delegate>(av_channel_layout_subset_ptr);
        ...
        vectors.av_channel_layout_uninit = (AVChannelLayout* @channel_layout) =>
        {
            ...
            vectors.av_channel_layout_uninit = av_channel_layout_uninit_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_layout_uninit_delegate>(av_channel_layout_uninit_ptr);
        ...
        vectors.av_channel_name = (byte* @buf, ulong @buf_size, AVChannel @channel) =>
        {
            ...
            vectors.av_channel_name = av_channel_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_name_delegate>(av_channel_name_ptr);
        ...
        vectors.av_channel_name_bprint = (AVBPrint* @bp, AVChannel @channel_id) =>
        {
            ...
            vectors.av_channel_name_bprint = av_channel_name_bprint_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_channel_name_bprint_delegate>(av_channel_name_bprint_ptr);
        ...
        vectors.av_chroma_location_enum_to_pos = (int* @xpos, int* @ypos, AVChromaLocation @pos) =>
        {
            ...
            vectors.av_chroma_location_enum_to_pos = av_chroma_location_enum_to_pos_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_chroma_location_enum_to_pos_delegate>(av_chroma_location_enum_to_pos_ptr);
        ...
        vectors.av_chroma_location_from_name = (string @name) =>
        {
            ...
            vectors.av_chroma_location_from_name = av_chroma_location_from_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_chroma_location_from_name_delegate>(av_chroma_location_from_name_ptr);
        ...
        vectors.av_chroma_location_name = (AVChromaLocation @location) =>
        {
            ...
            vectors.av_chroma_location_name = av_chroma_location_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_chroma_location_name_delegate>(av_chroma_location_name_ptr);
        ...
        vectors.av_chroma_location_pos_to_enum = (int @xpos, int @ypos) =>
        {
            ...
            vectors.av_chroma_location_pos_to_enum = av_chroma_location_pos_to_enum_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_chroma_location_pos_to_enum_delegate>(av_chroma_location_pos_to_enum_ptr);
        ...
        vectors.av_color_primaries_from_name = (string @name) =>
        {
            ...
            vectors.av_color_primaries_from_name = av_color_primaries_from_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_primaries_from_name_delegate>(av_color_primaries_from_name_ptr);
        ...
        vectors.av_color_primaries_name = (AVColorPrimaries @primaries) =>
        {
            ...
            vectors.av_color_primaries_name = av_color_primaries_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_primaries_name_delegate>(av_color_primaries_name_ptr);
        ...
        vectors.av_color_range_from_name = (string @name) =>
        {
            ...
            vectors.av_color_range_from_name = av_color_range_from_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_range_from_name_delegate>(av_color_range_from_name_ptr);
        ...
        vectors.av_color_range_name = (AVColorRange @range) =>
        {
            ...
            vectors.av_color_range_name = av_color_range_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_range_name_delegate>(av_color_range_name_ptr);
        ...
        vectors.av_color_space_from_name = (string @name) =>
        {
            ...
            vectors.av_color_space_from_name = av_color_space_from_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_space_from_name_delegate>(av_color_space_from_name_ptr);
        ...
        vectors.av_color_space_name = (AVColorSpace @space) =>
        {
            ...
            vectors.av_color_space_name = av_color_space_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_space_name_delegate>(av_color_space_name_ptr);
        ...
        vectors.av_color_transfer_from_name = (string @name) =>
        {
            ...
            vectors.av_color_transfer_from_name = av_color_transfer_from_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_transfer_from_name_delegate>(av_color_transfer_from_name_ptr);
        ...
        vectors.av_color_transfer_name = (AVColorTransferCharacteristic @transfer) =>
        {
            ...
            vectors.av_color_transfer_name = av_color_transfer_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_color_transfer_name_delegate>(av_color_transfer_name_ptr);
        ...
        vectors.av_compare_mod = (ulong @a, ulong @b, ulong @mod) =>
        {
            ...
            vectors.av_compare_mod = av_compare_mod_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_compare_mod_delegate>(av_compare_mod_ptr);
        ...
        vectors.av_compare_ts = (long @ts_a, AVRational @tb_a, long @ts_b, AVRational @tb_b) =>
        {
            ...
            vectors.av_compare_ts = av_compare_ts_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_compare_ts_delegate>(av_compare_ts_ptr);
        ...
        vectors.av_content_light_metadata_alloc = (ulong* @size) =>
        {
            ...
            vectors.av_content_light_metadata_alloc = av_content_light_metadata_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_content_light_metadata_alloc_delegate>(av_content_light_metadata_alloc_ptr);
        ...
        vectors.av_content_light_metadata_create_side_data = (AVFrame* @frame) =>
        {
            ...
            vectors.av_content_light_metadata_create_side_data = av_content_light_metadata_create_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_content_light_metadata_create_side_data_delegate>(av_content_light_metadata_create_side_data_ptr);
        ...
        vectors.av_cpu_count = () =>
        {
            ...
            vectors.av_cpu_count = av_cpu_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_cpu_count_delegate>(av_cpu_count_ptr);
        ...
        vectors.av_cpu_force_count = (int @count) =>
        {
            ...
            vectors.av_cpu_force_count = av_cpu_force_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_cpu_force_count_delegate>(av_cpu_force_count_ptr);
        ...
        vectors.av_cpu_max_align = () =>
        {
            ...
            vectors.av_cpu_max_align = av_cpu_max_align_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_cpu_max_align_delegate>(av_cpu_max_align_ptr);
        ...
        vectors.av_d2q = (double @d, int @max) =>
        {
            ...
            vectors.av_d2q = av_d2q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_d2q_delegate>(av_d2q_ptr);
        ...
        vectors.av_default_get_category = (void* @ptr) =>
        {
            ...
            vectors.av_default_get_category = av_default_get_category_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_default_get_category_delegate>(av_default_get_category_ptr);
        ...
        vectors.av_default_item_name = (void* @ctx) =>
        {
            ...
            vectors.av_default_item_name = av_default_item_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_default_item_name_delegate>(av_default_item_name_ptr);
        ...
        vectors.av_dict_copy = (AVDictionary** @dst, AVDictionary* @src, int @flags) =>
        {
            ...
            vectors.av_dict_copy = av_dict_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_copy_delegate>(av_dict_copy_ptr);
        ...
        vectors.av_dict_count = (AVDictionary* @m) =>
        {
            ...
            vectors.av_dict_count = av_dict_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_count_delegate>(av_dict_count_ptr);
        ...
        vectors.av_dict_free = (AVDictionary** @m) =>
        {
            ...
            vectors.av_dict_free = av_dict_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_free_delegate>(av_dict_free_ptr);
        ...
        vectors.av_dict_get = (AVDictionary* @m, string @key, AVDictionaryEntry* @prev, int @flags) =>
        {
            ...
            vectors.av_dict_get = av_dict_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_get_delegate>(av_dict_get_ptr);
        ...
        vectors.av_dict_get_string = (AVDictionary* @m, byte** @buffer, byte @key_val_sep, byte @pairs_sep) =>
        {
            ...
            vectors.av_dict_get_string = av_dict_get_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_get_string_delegate>(av_dict_get_string_ptr);
        ...
        vectors.av_dict_iterate = (AVDictionary* @m, AVDictionaryEntry* @prev) =>
        {
            ...
            vectors.av_dict_iterate = av_dict_iterate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_iterate_delegate>(av_dict_iterate_ptr);
        ...
        vectors.av_dict_parse_string = (AVDictionary** @pm, string @str, string @key_val_sep, string @pairs_sep, int @flags) =>
        {
            ...
            vectors.av_dict_parse_string = av_dict_parse_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_parse_string_delegate>(av_dict_parse_string_ptr);
        ...
        vectors.av_dict_set = (AVDictionary** @pm, string @key, string @value, int @flags) =>
        {
            ...
            vectors.av_dict_set = av_dict_set_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_set_delegate>(av_dict_set_ptr);
        ...
        vectors.av_dict_set_int = (AVDictionary** @pm, string @key, long @value, int @flags) =>
        {
            ...
            vectors.av_dict_set_int = av_dict_set_int_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dict_set_int_delegate>(av_dict_set_int_ptr);
        ...
        vectors.av_display_matrix_flip = (ref int_array9 @matrix, int @hflip, int @vflip) =>
        {
            ...
            vectors.av_display_matrix_flip = av_display_matrix_flip_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_display_matrix_flip_delegate>(av_display_matrix_flip_ptr);
        ...
        vectors.av_display_rotation_get = (in int_array9 @matrix) =>
        {
            ...
            vectors.av_display_rotation_get = av_display_rotation_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_display_rotation_get_delegate>(av_display_rotation_get_ptr);
        ...
        vectors.av_display_rotation_set = (ref int_array9 @matrix, double @angle) =>
        {
            ...
            vectors.av_display_rotation_set = av_display_rotation_set_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_display_rotation_set_delegate>(av_display_rotation_set_ptr);
        ...
        vectors.av_div_q = (AVRational @b, AVRational @c) =>
        {
            ...
            vectors.av_div_q = av_div_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_div_q_delegate>(av_div_q_ptr);
        ...
        vectors.av_dynamic_hdr_plus_alloc = (ulong* @size) =>
        {
            ...
            vectors.av_dynamic_hdr_plus_alloc = av_dynamic_hdr_plus_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynamic_hdr_plus_alloc_delegate>(av_dynamic_hdr_plus_alloc_ptr);
        ...
        vectors.av_dynamic_hdr_plus_create_side_data = (AVFrame* @frame) =>
        {
            ...
            vectors.av_dynamic_hdr_plus_create_side_data = av_dynamic_hdr_plus_create_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynamic_hdr_plus_create_side_data_delegate>(av_dynamic_hdr_plus_create_side_data_ptr);
        ...
        vectors.av_dynamic_hdr_plus_from_t35 = (AVDynamicHDRPlus* @s, byte* @data, ulong @size) =>
        {
            ...
            vectors.av_dynamic_hdr_plus_from_t35 = av_dynamic_hdr_plus_from_t35_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynamic_hdr_plus_from_t35_delegate>(av_dynamic_hdr_plus_from_t35_ptr);
        ...
        vectors.av_dynamic_hdr_plus_to_t35 = (AVDynamicHDRPlus* @s, byte** @data, ulong* @size) =>
        {
            ...
            vectors.av_dynamic_hdr_plus_to_t35 = av_dynamic_hdr_plus_to_t35_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynamic_hdr_plus_to_t35_delegate>(av_dynamic_hdr_plus_to_t35_ptr);
        ...
        vectors.av_dynarray_add = (void* @tab_ptr, int* @nb_ptr, void* @elem) =>
        {
            ...
            vectors.av_dynarray_add = av_dynarray_add_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynarray_add_delegate>(av_dynarray_add_ptr);
        ...
        vectors.av_dynarray_add_nofree = (void* @tab_ptr, int* @nb_ptr, void* @elem) =>
        {
            ...
            vectors.av_dynarray_add_nofree = av_dynarray_add_nofree_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynarray_add_nofree_delegate>(av_dynarray_add_nofree_ptr);
        ...
        vectors.av_dynarray2_add = (void** @tab_ptr, int* @nb_ptr, ulong @elem_size, byte* @elem_data) =>
        {
            ...
            vectors.av_dynarray2_add = av_dynarray2_add_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_dynarray2_add_delegate>(av_dynarray2_add_ptr);
        ...
        vectors.av_fast_malloc = (void* @ptr, uint* @size, ulong @min_size) =>
        {
            ...
            vectors.av_fast_malloc = av_fast_malloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_fast_malloc_delegate>(av_fast_malloc_ptr);
        ...
        vectors.av_fast_mallocz = (void* @ptr, uint* @size, ulong @min_size) =>
        {
            ...
            vectors.av_fast_mallocz = av_fast_mallocz_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_fast_mallocz_delegate>(av_fast_mallocz_ptr);
        ...
        vectors.av_fast_realloc = (void* @ptr, uint* @size, ulong @min_size) =>
        {
            ...
            vectors.av_fast_realloc = av_fast_realloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_fast_realloc_delegate>(av_fast_realloc_ptr);
        ...
        vectors.av_file_map = (string @filename, byte** @bufptr, ulong* @size, int @log_offset, void* @log_ctx) =>
        {
            ...
            vectors.av_file_map = av_file_map_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_file_map_delegate>(av_file_map_ptr);
        ...
        vectors.av_file_unmap = (byte* @bufptr, ulong @size) =>
        {
            ...
            vectors.av_file_unmap = av_file_unmap_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_file_unmap_delegate>(av_file_unmap_ptr);
        ...
        vectors.av_find_best_pix_fmt_of_2 = (AVPixelFormat @dst_pix_fmt1, AVPixelFormat @dst_pix_fmt2, AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) =>
        {
            ...
            vectors.av_find_best_pix_fmt_of_2 = av_find_best_pix_fmt_of_2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_find_best_pix_fmt_of_2_delegate>(av_find_best_pix_fmt_of_2_ptr);
        ...
        vectors.av_find_nearest_q_idx = (AVRational @q, AVRational* @q_list) =>
        {
            ...
            vectors.av_find_nearest_q_idx = av_find_nearest_q_idx_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_find_nearest_q_idx_delegate>(av_find_nearest_q_idx_ptr);
        ...
        vectors.av_force_cpu_flags = (int @flags) =>
        {
            ...
            vectors.av_force_cpu_flags = av_force_cpu_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_force_cpu_flags_delegate>(av_force_cpu_flags_ptr);
        ...
        vectors.av_fourcc_make_string = (byte* @buf, uint @fourcc) =>
        {
            ...
            vectors.av_fourcc_make_string = av_fourcc_make_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_fourcc_make_string_delegate>(av_fourcc_make_string_ptr);
        ...
        vectors.av_frame_alloc = () =>
        {
            ...
            vectors.av_frame_alloc = av_frame_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_alloc_delegate>(av_frame_alloc_ptr);
        ...
        vectors.av_frame_apply_cropping = (AVFrame* @frame, int @flags) =>
        {
            ...
            vectors.av_frame_apply_cropping = av_frame_apply_cropping_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_apply_cropping_delegate>(av_frame_apply_cropping_ptr);
        ...
        vectors.av_frame_clone = (AVFrame* @src) =>
        {
            ...
            vectors.av_frame_clone = av_frame_clone_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_clone_delegate>(av_frame_clone_ptr);
        ...
        vectors.av_frame_copy = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.av_frame_copy = av_frame_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_copy_delegate>(av_frame_copy_ptr);
        ...
        vectors.av_frame_copy_props = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.av_frame_copy_props = av_frame_copy_props_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_copy_props_delegate>(av_frame_copy_props_ptr);
        ...
        vectors.av_frame_free = (AVFrame** @frame) =>
        {
            ...
            vectors.av_frame_free = av_frame_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_free_delegate>(av_frame_free_ptr);
        ...
        vectors.av_frame_get_buffer = (AVFrame* @frame, int @align) =>
        {
            ...
            vectors.av_frame_get_buffer = av_frame_get_buffer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_get_buffer_delegate>(av_frame_get_buffer_ptr);
        ...
        vectors.av_frame_get_plane_buffer = (AVFrame* @frame, int @plane) =>
        {
            ...
            vectors.av_frame_get_plane_buffer = av_frame_get_plane_buffer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_get_plane_buffer_delegate>(av_frame_get_plane_buffer_ptr);
        ...
        vectors.av_frame_get_side_data = (AVFrame* @frame, AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_get_side_data = av_frame_get_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_get_side_data_delegate>(av_frame_get_side_data_ptr);
        ...
        vectors.av_frame_is_writable = (AVFrame* @frame) =>
        {
            ...
            vectors.av_frame_is_writable = av_frame_is_writable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_is_writable_delegate>(av_frame_is_writable_ptr);
        ...
        vectors.av_frame_make_writable = (AVFrame* @frame) =>
        {
            ...
            vectors.av_frame_make_writable = av_frame_make_writable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_make_writable_delegate>(av_frame_make_writable_ptr);
        ...
        vectors.av_frame_move_ref = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.av_frame_move_ref = av_frame_move_ref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_move_ref_delegate>(av_frame_move_ref_ptr);
        ...
        vectors.av_frame_new_side_data = (AVFrame* @frame, AVFrameSideDataType @type, ulong @size) =>
        {
            ...
            vectors.av_frame_new_side_data = av_frame_new_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_new_side_data_delegate>(av_frame_new_side_data_ptr);
        ...
        vectors.av_frame_new_side_data_from_buf = (AVFrame* @frame, AVFrameSideDataType @type, AVBufferRef* @buf) =>
        {
            ...
            vectors.av_frame_new_side_data_from_buf = av_frame_new_side_data_from_buf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_new_side_data_from_buf_delegate>(av_frame_new_side_data_from_buf_ptr);
        ...
        vectors.av_frame_ref = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.av_frame_ref = av_frame_ref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_ref_delegate>(av_frame_ref_ptr);
        ...
        vectors.av_frame_remove_side_data = (AVFrame* @frame, AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_remove_side_data = av_frame_remove_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_remove_side_data_delegate>(av_frame_remove_side_data_ptr);
        ...
        vectors.av_frame_replace = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.av_frame_replace = av_frame_replace_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_replace_delegate>(av_frame_replace_ptr);
        ...
        vectors.av_frame_side_data_add = (AVFrameSideData*** @sd, int* @nb_sd, AVFrameSideDataType @type, AVBufferRef** @buf, uint @flags) =>
        {
            ...
            vectors.av_frame_side_data_add = av_frame_side_data_add_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_add_delegate>(av_frame_side_data_add_ptr);
        ...
        vectors.av_frame_side_data_clone = (AVFrameSideData*** @sd, int* @nb_sd, AVFrameSideData* @src, uint @flags) =>
        {
            ...
            vectors.av_frame_side_data_clone = av_frame_side_data_clone_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_clone_delegate>(av_frame_side_data_clone_ptr);
        ...
        vectors.av_frame_side_data_desc = (AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_side_data_desc = av_frame_side_data_desc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_desc_delegate>(av_frame_side_data_desc_ptr);
        ...
        vectors.av_frame_side_data_free = (AVFrameSideData*** @sd, int* @nb_sd) =>
        {
            ...
            vectors.av_frame_side_data_free = av_frame_side_data_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_free_delegate>(av_frame_side_data_free_ptr);
        ...
        vectors.av_frame_side_data_get_c = (AVFrameSideData** @sd, int @nb_sd, AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_side_data_get_c = av_frame_side_data_get_c_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_get_c_delegate>(av_frame_side_data_get_c_ptr);
        ...
        vectors.av_frame_side_data_name = (AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_side_data_name = av_frame_side_data_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_name_delegate>(av_frame_side_data_name_ptr);
        ...
        vectors.av_frame_side_data_new = (AVFrameSideData*** @sd, int* @nb_sd, AVFrameSideDataType @type, ulong @size, uint @flags) =>
        {
            ...
            vectors.av_frame_side_data_new = av_frame_side_data_new_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_new_delegate>(av_frame_side_data_new_ptr);
        ...
        vectors.av_frame_side_data_remove = (AVFrameSideData*** @sd, int* @nb_sd, AVFrameSideDataType @type) =>
        {
            ...
            vectors.av_frame_side_data_remove = av_frame_side_data_remove_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_remove_delegate>(av_frame_side_data_remove_ptr);
        ...
        vectors.av_frame_side_data_remove_by_props = (AVFrameSideData*** @sd, int* @nb_sd, int @props) =>
        {
            ...
            vectors.av_frame_side_data_remove_by_props = av_frame_side_data_remove_by_props_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_side_data_remove_by_props_delegate>(av_frame_side_data_remove_by_props_ptr);
        ...
        vectors.av_frame_unref = (AVFrame* @frame) =>
        {
            ...
            vectors.av_frame_unref = av_frame_unref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_frame_unref_delegate>(av_frame_unref_ptr);
        ...
        vectors.av_free = (void* @ptr) =>
        {
            ...
            vectors.av_free = av_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_free_delegate>(av_free_ptr);
            vectors.av_free(@ptr);
        };
        ...
        vectors.av_freep = (void* @ptr) =>
        {
            ...
            vectors.av_freep = av_freep_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_freep_delegate>(av_freep_ptr);
        ...
        vectors.av_gcd = (long @a, long @b) =>
        {
            ...
            vectors.av_gcd = av_gcd_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_gcd_delegate>(av_gcd_ptr);
        ...
        vectors.av_gcd_q = (AVRational @a, AVRational @b, int @max_den, AVRational @def) =>
        {
            ...
            vectors.av_gcd_q = av_gcd_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_gcd_q_delegate>(av_gcd_q_ptr);
        ...
        vectors.av_get_alt_sample_fmt = (AVSampleFormat @sample_fmt, int @planar) =>
        {
            ...
            vectors.av_get_alt_sample_fmt = av_get_alt_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_alt_sample_fmt_delegate>(av_get_alt_sample_fmt_ptr);
        ...
        vectors.av_get_bits_per_pixel = (AVPixFmtDescriptor* @pixdesc) =>
        {
            ...
            vectors.av_get_bits_per_pixel = av_get_bits_per_pixel_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_bits_per_pixel_delegate>(av_get_bits_per_pixel_ptr);
        ...
        vectors.av_get_bytes_per_sample = (AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_get_bytes_per_sample = av_get_bytes_per_sample_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_bytes_per_sample_delegate>(av_get_bytes_per_sample_ptr);
        ...
        vectors.av_get_cpu_flags = () =>
        {
            ...
            vectors.av_get_cpu_flags = av_get_cpu_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_cpu_flags_delegate>(av_get_cpu_flags_ptr);
        ...
        vectors.av_get_media_type_string = (AVMediaType @media_type) =>
        {
            ...
            vectors.av_get_media_type_string = av_get_media_type_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_media_type_string_delegate>(av_get_media_type_string_ptr);
        ...
        vectors.av_get_packed_sample_fmt = (AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_get_packed_sample_fmt = av_get_packed_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_packed_sample_fmt_delegate>(av_get_packed_sample_fmt_ptr);
        ...
        vectors.av_get_padded_bits_per_pixel = (AVPixFmtDescriptor* @pixdesc) =>
        {
            ...
            vectors.av_get_padded_bits_per_pixel = av_get_padded_bits_per_pixel_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_padded_bits_per_pixel_delegate>(av_get_padded_bits_per_pixel_ptr);
        ...
        vectors.av_get_picture_type_char = (AVPictureType @pict_type) =>
        {
            ...
            vectors.av_get_picture_type_char = av_get_picture_type_char_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_picture_type_char_delegate>(av_get_picture_type_char_ptr);
        ...
        vectors.av_get_pix_fmt = (string @name) =>
        {
            ...
            vectors.av_get_pix_fmt = av_get_pix_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_pix_fmt_delegate>(av_get_pix_fmt_ptr);
        ...
        vectors.av_get_pix_fmt_loss = (AVPixelFormat @dst_pix_fmt, AVPixelFormat @src_pix_fmt, int @has_alpha) =>
        {
            ...
            vectors.av_get_pix_fmt_loss = av_get_pix_fmt_loss_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_pix_fmt_loss_delegate>(av_get_pix_fmt_loss_ptr);
        ...
        vectors.av_get_pix_fmt_name = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.av_get_pix_fmt_name = av_get_pix_fmt_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_pix_fmt_name_delegate>(av_get_pix_fmt_name_ptr);
        ...
        vectors.av_get_pix_fmt_string = (byte* @buf, int @buf_size, AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.av_get_pix_fmt_string = av_get_pix_fmt_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_pix_fmt_string_delegate>(av_get_pix_fmt_string_ptr);
        ...
        vectors.av_get_planar_sample_fmt = (AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_get_planar_sample_fmt = av_get_planar_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_planar_sample_fmt_delegate>(av_get_planar_sample_fmt_ptr);
        ...
        vectors.av_get_sample_fmt = (string @name) =>
        {
            ...
            vectors.av_get_sample_fmt = av_get_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_sample_fmt_delegate>(av_get_sample_fmt_ptr);
        ...
        vectors.av_get_sample_fmt_name = (AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_get_sample_fmt_name = av_get_sample_fmt_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_sample_fmt_name_delegate>(av_get_sample_fmt_name_ptr);
        ...
        vectors.av_get_sample_fmt_string = (byte* @buf, int @buf_size, AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_get_sample_fmt_string = av_get_sample_fmt_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_sample_fmt_string_delegate>(av_get_sample_fmt_string_ptr);
        ...
        vectors.av_get_time_base_q = () =>
        {
            ...
            vectors.av_get_time_base_q = av_get_time_base_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_get_time_base_q_delegate>(av_get_time_base_q_ptr);
        ...
        vectors.av_gettime = () =>
        {
            ...
            vectors.av_gettime = av_gettime_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_gettime_delegate>(av_gettime_ptr);
        ...
        vectors.av_gettime_relative = () =>
        {
            ...
            vectors.av_gettime_relative = av_gettime_relative_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_gettime_relative_delegate>(av_gettime_relative_ptr);
        ...
        vectors.av_gettime_relative_is_monotonic = () =>
        {
            ...
            vectors.av_gettime_relative_is_monotonic = av_gettime_relative_is_monotonic_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_gettime_relative_is_monotonic_delegate>(av_gettime_relative_is_monotonic_ptr);
        ...
        vectors.av_hwdevice_ctx_alloc = (AVHWDeviceType @type) =>
        {
            ...
            vectors.av_hwdevice_ctx_alloc = av_hwdevice_ctx_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_ctx_alloc_delegate>(av_hwdevice_ctx_alloc_ptr);
        ...
        vectors.av_hwdevice_ctx_create = (AVBufferRef** @device_ctx, AVHWDeviceType @type, string @device, AVDictionary* @opts, int @flags) =>
        {
            ...
            vectors.av_hwdevice_ctx_create = av_hwdevice_ctx_create_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_ctx_create_delegate>(av_hwdevice_ctx_create_ptr);
        ...
        vectors.av_hwdevice_ctx_create_derived = (AVBufferRef** @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, int @flags) =>
        {
            ...
            vectors.av_hwdevice_ctx_create_derived = av_hwdevice_ctx_create_derived_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_ctx_create_derived_delegate>(av_hwdevice_ctx_create_derived_ptr);
        ...
        vectors.av_hwdevice_ctx_create_derived_opts = (AVBufferRef** @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, AVDictionary* @options, int @flags) =>
        {
            ...
            vectors.av_hwdevice_ctx_create_derived_opts = av_hwdevice_ctx_create_derived_opts_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_ctx_create_derived_opts_delegate>(av_hwdevice_ctx_create_derived_opts_ptr);
        ...
        vectors.av_hwdevice_ctx_init = (AVBufferRef* @ref) =>
        {
            ...
            vectors.av_hwdevice_ctx_init = av_hwdevice_ctx_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_ctx_init_delegate>(av_hwdevice_ctx_init_ptr);
        ...
        vectors.av_hwdevice_find_type_by_name = (string @name) =>
        {
            ...
            vectors.av_hwdevice_find_type_by_name = av_hwdevice_find_type_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_find_type_by_name_delegate>(av_hwdevice_find_type_by_name_ptr);
        ...
        vectors.av_hwdevice_get_hwframe_constraints = (AVBufferRef* @ref, void* @hwconfig) =>
        {
            ...
            vectors.av_hwdevice_get_hwframe_constraints = av_hwdevice_get_hwframe_constraints_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_get_hwframe_constraints_delegate>(av_hwdevice_get_hwframe_constraints_ptr);
        ...
        vectors.av_hwdevice_get_type_name = (AVHWDeviceType @type) =>
        {
            ...
            vectors.av_hwdevice_get_type_name = av_hwdevice_get_type_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_get_type_name_delegate>(av_hwdevice_get_type_name_ptr);
        ...
        vectors.av_hwdevice_hwconfig_alloc = (AVBufferRef* @device_ctx) =>
        {
            ...
            vectors.av_hwdevice_hwconfig_alloc = av_hwdevice_hwconfig_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_hwconfig_alloc_delegate>(av_hwdevice_hwconfig_alloc_ptr);
        ...
        vectors.av_hwdevice_iterate_types = (AVHWDeviceType @prev) =>
        {
            ...
            vectors.av_hwdevice_iterate_types = av_hwdevice_iterate_types_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwdevice_iterate_types_delegate>(av_hwdevice_iterate_types_ptr);
        ...
        vectors.av_hwframe_constraints_free = (AVHWFramesConstraints** @constraints) =>
        {
            ...
            vectors.av_hwframe_constraints_free = av_hwframe_constraints_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_constraints_free_delegate>(av_hwframe_constraints_free_ptr);
        ...
        vectors.av_hwframe_ctx_alloc = (AVBufferRef* @device_ctx) =>
        {
            ...
            vectors.av_hwframe_ctx_alloc = av_hwframe_ctx_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_ctx_alloc_delegate>(av_hwframe_ctx_alloc_ptr);
        ...
        vectors.av_hwframe_ctx_create_derived = (AVBufferRef** @derived_frame_ctx, AVPixelFormat @format, AVBufferRef* @derived_device_ctx, AVBufferRef* @source_frame_ctx, int @flags) =>
        {
            ...
            vectors.av_hwframe_ctx_create_derived = av_hwframe_ctx_create_derived_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_ctx_create_derived_delegate>(av_hwframe_ctx_create_derived_ptr);
        ...
        vectors.av_hwframe_ctx_init = (AVBufferRef* @ref) =>
        {
            ...
            vectors.av_hwframe_ctx_init = av_hwframe_ctx_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_ctx_init_delegate>(av_hwframe_ctx_init_ptr);
        ...
        vectors.av_hwframe_get_buffer = (AVBufferRef* @hwframe_ctx, AVFrame* @frame, int @flags) =>
        {
            ...
            vectors.av_hwframe_get_buffer = av_hwframe_get_buffer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_get_buffer_delegate>(av_hwframe_get_buffer_ptr);
        ...
        vectors.av_hwframe_map = (AVFrame* @dst, AVFrame* @src, int @flags) =>
        {
            ...
            vectors.av_hwframe_map = av_hwframe_map_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_map_delegate>(av_hwframe_map_ptr);
        ...
        vectors.av_hwframe_transfer_data = (AVFrame* @dst, AVFrame* @src, int @flags) =>
        {
            ...
            vectors.av_hwframe_transfer_data = av_hwframe_transfer_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_transfer_data_delegate>(av_hwframe_transfer_data_ptr);
        ...
        vectors.av_hwframe_transfer_get_formats = (AVBufferRef* @hwframe_ctx, AVHWFrameTransferDirection @dir, AVPixelFormat** @formats, int @flags) =>
        {
            ...
            vectors.av_hwframe_transfer_get_formats = av_hwframe_transfer_get_formats_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_hwframe_transfer_get_formats_delegate>(av_hwframe_transfer_get_formats_ptr);
        ...
        vectors.av_image_alloc = (ref byte_ptrArray4 @pointers, ref int_array4 @linesizes, int @w, int @h, AVPixelFormat @pix_fmt, int @align) =>
        {
            ...
            vectors.av_image_alloc = av_image_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_alloc_delegate>(av_image_alloc_ptr);
        ...
        vectors.av_image_check_sar = (uint @w, uint @h, AVRational @sar) =>
        {
            ...
            vectors.av_image_check_sar = av_image_check_sar_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_check_sar_delegate>(av_image_check_sar_ptr);
        ...
        vectors.av_image_check_size = (uint @w, uint @h, int @log_offset, void* @log_ctx) =>
        {
            ...
            vectors.av_image_check_size = av_image_check_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_check_size_delegate>(av_image_check_size_ptr);
        ...
        vectors.av_image_check_size2 = (uint @w, uint @h, long @max_pixels, AVPixelFormat @pix_fmt, int @log_offset, void* @log_ctx) =>
        {
            ...
            vectors.av_image_check_size2 = av_image_check_size2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_check_size2_delegate>(av_image_check_size2_ptr);
        ...
        vectors.av_image_copy = (ref byte_ptrArray4 @dst_data, in int_array4 @dst_linesizes, in byte_ptrArray4 @src_data, in int_array4 @src_linesizes, AVPixelFormat @pix_fmt, int @width, int @height) =>
        {
            ...
            vectors.av_image_copy = av_image_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_copy_delegate>(av_image_copy_ptr);
        ...
        vectors.av_image_copy_plane = (byte* @dst, int @dst_linesize, byte* @src, int @src_linesize, int @bytewidth, int @height) =>
        {
            ...
            vectors.av_image_copy_plane = av_image_copy_plane_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_copy_plane_delegate>(av_image_copy_plane_ptr);
        ...
        vectors.av_image_copy_plane_uc_from = (byte* @dst, long @dst_linesize, byte* @src, long @src_linesize, long @bytewidth, int @height) =>
        {
            ...
            vectors.av_image_copy_plane_uc_from = av_image_copy_plane_uc_from_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_copy_plane_uc_from_delegate>(av_image_copy_plane_uc_from_ptr);
        ...
        vectors.av_image_copy_to_buffer = (byte* @dst, int @dst_size, in byte_ptrArray4 @src_data, in int_array4 @src_linesize, AVPixelFormat @pix_fmt, int @width, int @height, int @align) =>
        {
            ...
            vectors.av_image_copy_to_buffer = av_image_copy_to_buffer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_copy_to_buffer_delegate>(av_image_copy_to_buffer_ptr);
        ...
        vectors.av_image_copy_uc_from = (ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesizes, in byte_ptrArray4 @src_data, in long_array4 @src_linesizes, AVPixelFormat @pix_fmt, int @width, int @height) =>
        {
            ...
            vectors.av_image_copy_uc_from = av_image_copy_uc_from_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_copy_uc_from_delegate>(av_image_copy_uc_from_ptr);
        ...
        vectors.av_image_fill_arrays = (ref byte_ptrArray4 @dst_data, ref int_array4 @dst_linesize, byte* @src, AVPixelFormat @pix_fmt, int @width, int @height, int @align) =>
        {
            ...
            vectors.av_image_fill_arrays = av_image_fill_arrays_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_arrays_delegate>(av_image_fill_arrays_ptr);
        ...
        vectors.av_image_fill_black = (ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesize, AVPixelFormat @pix_fmt, AVColorRange @range, int @width, int @height) =>
        {
            ...
            vectors.av_image_fill_black = av_image_fill_black_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_black_delegate>(av_image_fill_black_ptr);
        ...
        vectors.av_image_fill_color = (ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesize, AVPixelFormat @pix_fmt, in uint_array4 @color, int @width, int @height, int @flags) =>
        {
            ...
            vectors.av_image_fill_color = av_image_fill_color_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_color_delegate>(av_image_fill_color_ptr);
        ...
        vectors.av_image_fill_linesizes = (ref int_array4 @linesizes, AVPixelFormat @pix_fmt, int @width) =>
        {
            ...
            vectors.av_image_fill_linesizes = av_image_fill_linesizes_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_linesizes_delegate>(av_image_fill_linesizes_ptr);
        ...
        vectors.av_image_fill_max_pixsteps = (ref int_array4 @max_pixsteps, ref int_array4 @max_pixstep_comps, AVPixFmtDescriptor* @pixdesc) =>
        {
            ...
            vectors.av_image_fill_max_pixsteps = av_image_fill_max_pixsteps_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_max_pixsteps_delegate>(av_image_fill_max_pixsteps_ptr);
        ...
        vectors.av_image_fill_plane_sizes = (ref ulong_array4 @size, AVPixelFormat @pix_fmt, int @height, in long_array4 @linesizes) =>
        {
            ...
            vectors.av_image_fill_plane_sizes = av_image_fill_plane_sizes_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_plane_sizes_delegate>(av_image_fill_plane_sizes_ptr);
        ...
        vectors.av_image_fill_pointers = (ref byte_ptrArray4 @data, AVPixelFormat @pix_fmt, int @height, byte* @ptr, in int_array4 @linesizes) =>
        {
            ...
            vectors.av_image_fill_pointers = av_image_fill_pointers_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_fill_pointers_delegate>(av_image_fill_pointers_ptr);
        ...
        vectors.av_image_get_buffer_size = (AVPixelFormat @pix_fmt, int @width, int @height, int @align) =>
        {
            ...
            vectors.av_image_get_buffer_size = av_image_get_buffer_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_get_buffer_size_delegate>(av_image_get_buffer_size_ptr);
        ...
        vectors.av_image_get_linesize = (AVPixelFormat @pix_fmt, int @width, int @plane) =>
        {
            ...
            vectors.av_image_get_linesize = av_image_get_linesize_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_image_get_linesize_delegate>(av_image_get_linesize_ptr);
        ...
        vectors.av_int_list_length_for_size = (uint @elsize, void* @list, ulong @term) =>
        {
            ...
            vectors.av_int_list_length_for_size = av_int_list_length_for_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_int_list_length_for_size_delegate>(av_int_list_length_for_size_ptr);
        ...
        vectors.av_log = (void* @avcl, int @level, string @fmt) =>
        {
            ...
            vectors.av_log = av_log_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_delegate>(av_log_ptr);
        ...
        vectors.av_log_default_callback = (void* @avcl, int @level, string @fmt, byte* @vl) =>
        {
            ...
            vectors.av_log_default_callback = av_log_default_callback_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_default_callback_delegate>(av_log_default_callback_ptr);
        ...
        vectors.av_log_format_line = (void* @ptr, int @level, string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix) =>
        {
            ...
            vectors.av_log_format_line = av_log_format_line_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_format_line_delegate>(av_log_format_line_ptr);
        ...
        vectors.av_log_format_line2 = (void* @ptr, int @level, string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix) =>
        {
            ...
            vectors.av_log_format_line2 = av_log_format_line2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_format_line2_delegate>(av_log_format_line2_ptr);
        ...
        vectors.av_log_get_flags = () =>
        {
            ...
            vectors.av_log_get_flags = av_log_get_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_get_flags_delegate>(av_log_get_flags_ptr);
        ...
        vectors.av_log_get_level = () =>
        {
            ...
            vectors.av_log_get_level = av_log_get_level_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_get_level_delegate>(av_log_get_level_ptr);
        ...
        vectors.av_log_once = (void* @avcl, int @initial_level, int @subsequent_level, int* @state, string @fmt) =>
        {
            ...
            vectors.av_log_once = av_log_once_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_once_delegate>(av_log_once_ptr);
        ...
        vectors.av_log_set_callback = (av_log_set_callback_callback_func @callback) =>
        {
            ...
            vectors.av_log_set_callback = av_log_set_callback_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_set_callback_delegate>(av_log_set_callback_ptr);
        ...
        vectors.av_log_set_flags = (int @arg) =>
        {
            ...
            vectors.av_log_set_flags = av_log_set_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_set_flags_delegate>(av_log_set_flags_ptr);
        ...
        vectors.av_log_set_level = (int @level) =>
        {
            ...
            vectors.av_log_set_level = av_log_set_level_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log_set_level_delegate>(av_log_set_level_ptr);
        ...
        vectors.av_log2 = (uint @v) =>
        {
            ...
            vectors.av_log2 = av_log2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log2_delegate>(av_log2_ptr);
        ...
        vectors.av_log2_16bit = (uint @v) =>
        {
            ...
            vectors.av_log2_16bit = av_log2_16bit_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_log2_16bit_delegate>(av_log2_16bit_ptr);
        ...
        vectors.av_malloc = (ulong @size) =>
        {
            ...
            vectors.av_malloc = av_malloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_malloc_delegate>(av_malloc_ptr);
        ...
        vectors.av_malloc_array = (ulong @nmemb, ulong @size) =>
        {
            ...
            vectors.av_malloc_array = av_malloc_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_malloc_array_delegate>(av_malloc_array_ptr);
        ...
        vectors.av_mallocz = (ulong @size) =>
        {
            ...
            vectors.av_mallocz = av_mallocz_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_mallocz_delegate>(av_mallocz_ptr);
        ...
        vectors.av_mastering_display_metadata_alloc = () =>
        {
            ...
            vectors.av_mastering_display_metadata_alloc = av_mastering_display_metadata_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_mastering_display_metadata_alloc_delegate>(av_mastering_display_metadata_alloc_ptr);
        ...
        vectors.av_mastering_display_metadata_alloc_size = (ulong* @size) =>
        {
            ...
            vectors.av_mastering_display_metadata_alloc_size = av_mastering_display_metadata_alloc_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_mastering_display_metadata_alloc_size_delegate>(av_mastering_display_metadata_alloc_size_ptr);
        ...
        vectors.av_mastering_display_metadata_create_side_data = (AVFrame* @frame) =>
        {
            ...
            vectors.av_mastering_display_metadata_create_side_data = av_mastering_display_metadata_create_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_mastering_display_metadata_create_side_data_delegate>(av_mastering_display_metadata_create_side_data_ptr);
        ...
        vectors.av_max_alloc = (ulong @max) =>
        {
            ...
            vectors.av_max_alloc = av_max_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_max_alloc_delegate>(av_max_alloc_ptr);
        ...
        vectors.av_memcpy_backptr = (byte* @dst, int @back, int @cnt) =>
        {
            ...
            vectors.av_memcpy_backptr = av_memcpy_backptr_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_memcpy_backptr_delegate>(av_memcpy_backptr_ptr);
        ...
        vectors.av_memdup = (void* @p, ulong @size) =>
        {
            ...
            vectors.av_memdup = av_memdup_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_memdup_delegate>(av_memdup_ptr);
        ...
        vectors.av_mul_q = (AVRational @b, AVRational @c) =>
        {
            ...
            vectors.av_mul_q = av_mul_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_mul_q_delegate>(av_mul_q_ptr);
        ...
        vectors.av_nearer_q = (AVRational @q, AVRational @q1, AVRational @q2) =>
        {
            ...
            vectors.av_nearer_q = av_nearer_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_nearer_q_delegate>(av_nearer_q_ptr);
        ...
        vectors.av_opt_child_class_iterate = (AVClass* @parent, void** @iter) =>
        {
            ...
            vectors.av_opt_child_class_iterate = av_opt_child_class_iterate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_child_class_iterate_delegate>(av_opt_child_class_iterate_ptr);
        ...
        vectors.av_opt_child_next = (void* @obj, void* @prev) =>
        {
            ...
            vectors.av_opt_child_next = av_opt_child_next_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_child_next_delegate>(av_opt_child_next_ptr);
        ...
        vectors.av_opt_copy = (void* @dest, void* @src) =>
        {
            ...
            vectors.av_opt_copy = av_opt_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_copy_delegate>(av_opt_copy_ptr);
        ...
        vectors.av_opt_eval_double = (void* @obj, AVOption* @o, string @val, double* @double_out) =>
        {
            ...
            vectors.av_opt_eval_double = av_opt_eval_double_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_double_delegate>(av_opt_eval_double_ptr);
        ...
        vectors.av_opt_eval_flags = (void* @obj, AVOption* @o, string @val, int* @flags_out) =>
        {
            ...
            vectors.av_opt_eval_flags = av_opt_eval_flags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_flags_delegate>(av_opt_eval_flags_ptr);
        ...
        vectors.av_opt_eval_float = (void* @obj, AVOption* @o, string @val, float* @float_out) =>
        {
            ...
            vectors.av_opt_eval_float = av_opt_eval_float_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_float_delegate>(av_opt_eval_float_ptr);
        ...
        vectors.av_opt_eval_int = (void* @obj, AVOption* @o, string @val, int* @int_out) =>
        {
            ...
            vectors.av_opt_eval_int = av_opt_eval_int_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_int_delegate>(av_opt_eval_int_ptr);
        ...
        vectors.av_opt_eval_int64 = (void* @obj, AVOption* @o, string @val, long* @int64_out) =>
        {
            ...
            vectors.av_opt_eval_int64 = av_opt_eval_int64_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_int64_delegate>(av_opt_eval_int64_ptr);
        ...
        vectors.av_opt_eval_q = (void* @obj, AVOption* @o, string @val, AVRational* @q_out) =>
        {
            ...
            vectors.av_opt_eval_q = av_opt_eval_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_q_delegate>(av_opt_eval_q_ptr);
        ...
        vectors.av_opt_eval_uint = (void* @obj, AVOption* @o, string @val, uint* @uint_out) =>
        {
            ...
            vectors.av_opt_eval_uint = av_opt_eval_uint_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_eval_uint_delegate>(av_opt_eval_uint_ptr);
        ...
        vectors.av_opt_find = (void* @obj, string @name, string @unit, int @opt_flags, int @search_flags) =>
        {
            ...
            vectors.av_opt_find = av_opt_find_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_find_delegate>(av_opt_find_ptr);
        ...
        vectors.av_opt_find2 = (void* @obj, string @name, string @unit, int @opt_flags, int @search_flags, void** @target_obj) =>
        {
            ...
            vectors.av_opt_find2 = av_opt_find2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_find2_delegate>(av_opt_find2_ptr);
        ...
        vectors.av_opt_flag_is_set = (void* @obj, string @field_name, string @flag_name) =>
        {
            ...
            vectors.av_opt_flag_is_set = av_opt_flag_is_set_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_flag_is_set_delegate>(av_opt_flag_is_set_ptr);
        ...
        vectors.av_opt_free = (void* @obj) =>
        {
            ...
            vectors.av_opt_free = av_opt_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_free_delegate>(av_opt_free_ptr);
        ...
        vectors.av_opt_freep_ranges = (AVOptionRanges** @ranges) =>
        {
            ...
            vectors.av_opt_freep_ranges = av_opt_freep_ranges_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_freep_ranges_delegate>(av_opt_freep_ranges_ptr);
        ...
        vectors.av_opt_get = (void* @obj, string @name, int @search_flags, byte** @out_val) =>
        {
            ...
            vectors.av_opt_get = av_opt_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_delegate>(av_opt_get_ptr);
        ...
        vectors.av_opt_get_array = (void* @obj, string @name, int @search_flags, uint @start_elem, uint @nb_elems, AVOptionType @out_type, void* @out_val) =>
        {
            ...
            vectors.av_opt_get_array = av_opt_get_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_array_delegate>(av_opt_get_array_ptr);
        ...
        vectors.av_opt_get_array_size = (void* @obj, string @name, int @search_flags, uint* @out_val) =>
        {
            ...
            vectors.av_opt_get_array_size = av_opt_get_array_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_array_size_delegate>(av_opt_get_array_size_ptr);
        ...
        vectors.av_opt_get_chlayout = (void* @obj, string @name, int @search_flags, AVChannelLayout* @layout) =>
        {
            ...
            vectors.av_opt_get_chlayout = av_opt_get_chlayout_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_chlayout_delegate>(av_opt_get_chlayout_ptr);
        ...
        vectors.av_opt_get_dict_val = (void* @obj, string @name, int @search_flags, AVDictionary** @out_val) =>
        {
            ...
            vectors.av_opt_get_dict_val = av_opt_get_dict_val_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_dict_val_delegate>(av_opt_get_dict_val_ptr);
        ...
        vectors.av_opt_get_double = (void* @obj, string @name, int @search_flags, double* @out_val) =>
        {
            ...
            vectors.av_opt_get_double = av_opt_get_double_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_double_delegate>(av_opt_get_double_ptr);
        ...
        vectors.av_opt_get_image_size = (void* @obj, string @name, int @search_flags, int* @w_out, int* @h_out) =>
        {
            ...
            vectors.av_opt_get_image_size = av_opt_get_image_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_image_size_delegate>(av_opt_get_image_size_ptr);
        ...
        vectors.av_opt_get_int = (void* @obj, string @name, int @search_flags, long* @out_val) =>
        {
            ...
            vectors.av_opt_get_int = av_opt_get_int_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_int_delegate>(av_opt_get_int_ptr);
        ...
        vectors.av_opt_get_key_value = (byte** @ropts, string @key_val_sep, string @pairs_sep, uint @flags, byte** @rkey, byte** @rval) =>
        {
            ...
            vectors.av_opt_get_key_value = av_opt_get_key_value_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_key_value_delegate>(av_opt_get_key_value_ptr);
        ...
        vectors.av_opt_get_pixel_fmt = (void* @obj, string @name, int @search_flags, AVPixelFormat* @out_fmt) =>
        {
            ...
            vectors.av_opt_get_pixel_fmt = av_opt_get_pixel_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_pixel_fmt_delegate>(av_opt_get_pixel_fmt_ptr);
        ...
        vectors.av_opt_get_q = (void* @obj, string @name, int @search_flags, AVRational* @out_val) =>
        {
            ...
            vectors.av_opt_get_q = av_opt_get_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_q_delegate>(av_opt_get_q_ptr);
        ...
        vectors.av_opt_get_sample_fmt = (void* @obj, string @name, int @search_flags, AVSampleFormat* @out_fmt) =>
        {
            ...
            vectors.av_opt_get_sample_fmt = av_opt_get_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_sample_fmt_delegate>(av_opt_get_sample_fmt_ptr);
        ...
        vectors.av_opt_get_video_rate = (void* @obj, string @name, int @search_flags, AVRational* @out_val) =>
        {
            ...
            vectors.av_opt_get_video_rate = av_opt_get_video_rate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_get_video_rate_delegate>(av_opt_get_video_rate_ptr);
        ...
        vectors.av_opt_is_set_to_default = (void* @obj, AVOption* @o) =>
        {
            ...
            vectors.av_opt_is_set_to_default = av_opt_is_set_to_default_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_is_set_to_default_delegate>(av_opt_is_set_to_default_ptr);
        ...
        vectors.av_opt_is_set_to_default_by_name = (void* @obj, string @name, int @search_flags) =>
        {
            ...
            vectors.av_opt_is_set_to_default_by_name = av_opt_is_set_to_default_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_is_set_to_default_by_name_delegate>(av_opt_is_set_to_default_by_name_ptr);
        ...
        vectors.av_opt_next = (void* @obj, AVOption* @prev) =>
        {
            ...
            vectors.av_opt_next = av_opt_next_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_next_delegate>(av_opt_next_ptr);
        ...
        vectors.av_opt_ptr = (AVClass* @avclass, void* @obj, string @name) =>
        {
            ...
            vectors.av_opt_ptr = av_opt_ptr_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_ptr_delegate>(av_opt_ptr_ptr);
        ...
        vectors.av_opt_query_ranges = (AVOptionRanges** @p0, void* @obj, string @key, int @flags) =>
        {
            ...
            vectors.av_opt_query_ranges = av_opt_query_ranges_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_query_ranges_delegate>(av_opt_query_ranges_ptr);
        ...
        vectors.av_opt_query_ranges_default = (AVOptionRanges** @p0, void* @obj, string @key, int @flags) =>
        {
            ...
            vectors.av_opt_query_ranges_default = av_opt_query_ranges_default_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_query_ranges_default_delegate>(av_opt_query_ranges_default_ptr);
        ...
        vectors.av_opt_serialize = (void* @obj, int @opt_flags, int @flags, byte** @buffer, byte @key_val_sep, byte @pairs_sep) =>
        {
            ...
            vectors.av_opt_serialize = av_opt_serialize_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_serialize_delegate>(av_opt_serialize_ptr);
        ...
        vectors.av_opt_set = (void* @obj, string @name, string @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set = av_opt_set_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_delegate>(av_opt_set_ptr);
        ...
        vectors.av_opt_set_array = (void* @obj, string @name, int @search_flags, uint @start_elem, uint @nb_elems, AVOptionType @val_type, void* @val) =>
        {
            ...
            vectors.av_opt_set_array = av_opt_set_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_array_delegate>(av_opt_set_array_ptr);
        ...
        vectors.av_opt_set_bin = (void* @obj, string @name, byte* @val, int @size, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_bin = av_opt_set_bin_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_bin_delegate>(av_opt_set_bin_ptr);
        ...
        vectors.av_opt_set_chlayout = (void* @obj, string @name, AVChannelLayout* @layout, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_chlayout = av_opt_set_chlayout_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_chlayout_delegate>(av_opt_set_chlayout_ptr);
        ...
        vectors.av_opt_set_defaults = (void* @s) =>
        {
            ...
            vectors.av_opt_set_defaults = av_opt_set_defaults_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_defaults_delegate>(av_opt_set_defaults_ptr);
        ...
        vectors.av_opt_set_defaults2 = (void* @s, int @mask, int @flags) =>
        {
            ...
            vectors.av_opt_set_defaults2 = av_opt_set_defaults2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_defaults2_delegate>(av_opt_set_defaults2_ptr);
        ...
        vectors.av_opt_set_dict = (void* @obj, AVDictionary** @options) =>
        {
            ...
            vectors.av_opt_set_dict = av_opt_set_dict_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_dict_delegate>(av_opt_set_dict_ptr);
        ...
        vectors.av_opt_set_dict_val = (void* @obj, string @name, AVDictionary* @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_dict_val = av_opt_set_dict_val_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_dict_val_delegate>(av_opt_set_dict_val_ptr);
        ...
        vectors.av_opt_set_dict2 = (void* @obj, AVDictionary** @options, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_dict2 = av_opt_set_dict2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_dict2_delegate>(av_opt_set_dict2_ptr);
        ...
        vectors.av_opt_set_double = (void* @obj, string @name, double @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_double = av_opt_set_double_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_double_delegate>(av_opt_set_double_ptr);
        ...
        vectors.av_opt_set_from_string = (void* @ctx, string @opts, byte** @shorthand, string @key_val_sep, string @pairs_sep) =>
        {
            ...
            vectors.av_opt_set_from_string = av_opt_set_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_from_string_delegate>(av_opt_set_from_string_ptr);
        ...
        vectors.av_opt_set_image_size = (void* @obj, string @name, int @w, int @h, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_image_size = av_opt_set_image_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_image_size_delegate>(av_opt_set_image_size_ptr);
        ...
        vectors.av_opt_set_int = (void* @obj, string @name, long @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_int = av_opt_set_int_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_int_delegate>(av_opt_set_int_ptr);
        ...
        vectors.av_opt_set_pixel_fmt = (void* @obj, string @name, AVPixelFormat @fmt, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_pixel_fmt = av_opt_set_pixel_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_pixel_fmt_delegate>(av_opt_set_pixel_fmt_ptr);
        ...
        vectors.av_opt_set_q = (void* @obj, string @name, AVRational @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_q = av_opt_set_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_q_delegate>(av_opt_set_q_ptr);
        ...
        vectors.av_opt_set_sample_fmt = (void* @obj, string @name, AVSampleFormat @fmt, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_sample_fmt = av_opt_set_sample_fmt_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_sample_fmt_delegate>(av_opt_set_sample_fmt_ptr);
        ...
        vectors.av_opt_set_video_rate = (void* @obj, string @name, AVRational @val, int @search_flags) =>
        {
            ...
            vectors.av_opt_set_video_rate = av_opt_set_video_rate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_set_video_rate_delegate>(av_opt_set_video_rate_ptr);
        ...
        vectors.av_opt_show2 = (void* @obj, void* @av_log_obj, int @req_flags, int @rej_flags) =>
        {
            ...
            vectors.av_opt_show2 = av_opt_show2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_opt_show2_delegate>(av_opt_show2_ptr);
        ...
        vectors.av_packet_add_side_data = (AVPacket* @pkt, AVPacketSideDataType @type, byte* @data, ulong @size) =>
        {
            ...
            vectors.av_packet_add_side_data = av_packet_add_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_add_side_data_delegate>(av_packet_add_side_data_ptr);
        ...
        vectors.av_packet_alloc = () =>
        {
            ...
            vectors.av_packet_alloc = av_packet_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_alloc_delegate>(av_packet_alloc_ptr);
        ...
        vectors.av_packet_clone = (AVPacket* @src) =>
        {
            ...
            vectors.av_packet_clone = av_packet_clone_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_clone_delegate>(av_packet_clone_ptr);
        ...
        vectors.av_packet_copy_props = (AVPacket* @dst, AVPacket* @src) =>
        {
            ...
            vectors.av_packet_copy_props = av_packet_copy_props_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_copy_props_delegate>(av_packet_copy_props_ptr);
        ...
        vectors.av_packet_free = (AVPacket** @pkt) =>
        {
            ...
            vectors.av_packet_free = av_packet_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_free_delegate>(av_packet_free_ptr);
        ...
        vectors.av_packet_free_side_data = (AVPacket* @pkt) =>
        {
            ...
            vectors.av_packet_free_side_data = av_packet_free_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_free_side_data_delegate>(av_packet_free_side_data_ptr);
        ...
        vectors.av_packet_from_data = (AVPacket* @pkt, byte* @data, int @size) =>
        {
            ...
            vectors.av_packet_from_data = av_packet_from_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_from_data_delegate>(av_packet_from_data_ptr);
        ...
        vectors.av_packet_get_side_data = (AVPacket* @pkt, AVPacketSideDataType @type, ulong* @size) =>
        {
            ...
            vectors.av_packet_get_side_data = av_packet_get_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_get_side_data_delegate>(av_packet_get_side_data_ptr);
        ...
        vectors.av_packet_make_refcounted = (AVPacket* @pkt) =>
        {
            ...
            vectors.av_packet_make_refcounted = av_packet_make_refcounted_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_make_refcounted_delegate>(av_packet_make_refcounted_ptr);
        ...
        vectors.av_packet_make_writable = (AVPacket* @pkt) =>
        {
            ...
            vectors.av_packet_make_writable = av_packet_make_writable_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_make_writable_delegate>(av_packet_make_writable_ptr);
        ...
        vectors.av_packet_move_ref = (AVPacket* @dst, AVPacket* @src) =>
        {
            ...
            vectors.av_packet_move_ref = av_packet_move_ref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_move_ref_delegate>(av_packet_move_ref_ptr);
        ...
        vectors.av_packet_new_side_data = (AVPacket* @pkt, AVPacketSideDataType @type, ulong @size) =>
        {
            ...
            vectors.av_packet_new_side_data = av_packet_new_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_new_side_data_delegate>(av_packet_new_side_data_ptr);
        ...
        vectors.av_packet_pack_dictionary = (AVDictionary* @dict, ulong* @size) =>
        {
            ...
            vectors.av_packet_pack_dictionary = av_packet_pack_dictionary_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_pack_dictionary_delegate>(av_packet_pack_dictionary_ptr);
        ...
        vectors.av_packet_ref = (AVPacket* @dst, AVPacket* @src) =>
        {
            ...
            vectors.av_packet_ref = av_packet_ref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_ref_delegate>(av_packet_ref_ptr);
        ...
        vectors.av_packet_rescale_ts = (AVPacket* @pkt, AVRational @tb_src, AVRational @tb_dst) =>
        {
            ...
            vectors.av_packet_rescale_ts = av_packet_rescale_ts_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_rescale_ts_delegate>(av_packet_rescale_ts_ptr);
        ...
        vectors.av_packet_shrink_side_data = (AVPacket* @pkt, AVPacketSideDataType @type, ulong @size) =>
        {
            ...
            vectors.av_packet_shrink_side_data = av_packet_shrink_side_data_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_shrink_side_data_delegate>(av_packet_shrink_side_data_ptr);
        ...
        vectors.av_packet_side_data_add = (AVPacketSideData** @sd, int* @nb_sd, AVPacketSideDataType @type, void* @data, ulong @size, int @flags) =>
        {
            ...
            vectors.av_packet_side_data_add = av_packet_side_data_add_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_add_delegate>(av_packet_side_data_add_ptr);
        ...
        vectors.av_packet_side_data_free = (AVPacketSideData** @sd, int* @nb_sd) =>
        {
            ...
            vectors.av_packet_side_data_free = av_packet_side_data_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_free_delegate>(av_packet_side_data_free_ptr);
        ...
        vectors.av_packet_side_data_get = (AVPacketSideData* @sd, int @nb_sd, AVPacketSideDataType @type) =>
        {
            ...
            vectors.av_packet_side_data_get = av_packet_side_data_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_get_delegate>(av_packet_side_data_get_ptr);
        ...
        vectors.av_packet_side_data_name = (AVPacketSideDataType @type) =>
        {
            ...
            vectors.av_packet_side_data_name = av_packet_side_data_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_name_delegate>(av_packet_side_data_name_ptr);
        ...
        vectors.av_packet_side_data_new = (AVPacketSideData** @psd, int* @pnb_sd, AVPacketSideDataType @type, ulong @size, int @flags) =>
        {
            ...
            vectors.av_packet_side_data_new = av_packet_side_data_new_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_new_delegate>(av_packet_side_data_new_ptr);
        ...
        vectors.av_packet_side_data_remove = (AVPacketSideData* @sd, int* @nb_sd, AVPacketSideDataType @type) =>
        {
            ...
            vectors.av_packet_side_data_remove = av_packet_side_data_remove_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_side_data_remove_delegate>(av_packet_side_data_remove_ptr);
        ...
        vectors.av_packet_unpack_dictionary = (byte* @data, ulong @size, AVDictionary** @dict) =>
        {
            ...
            vectors.av_packet_unpack_dictionary = av_packet_unpack_dictionary_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_unpack_dictionary_delegate>(av_packet_unpack_dictionary_ptr);
        ...
        vectors.av_packet_unref = (AVPacket* @pkt) =>
        {
            ...
            vectors.av_packet_unref = av_packet_unref_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_packet_unref_delegate>(av_packet_unref_ptr);
        ...
        vectors.av_parse_cpu_caps = (uint* @flags, string @s) =>
        {
            ...
            vectors.av_parse_cpu_caps = av_parse_cpu_caps_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_parse_cpu_caps_delegate>(av_parse_cpu_caps_ptr);
        ...
        vectors.av_parser_close = (AVCodecParserContext* @s) =>
        {
            ...
            vectors.av_parser_close = av_parser_close_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_parser_close_delegate>(av_parser_close_ptr);
        ...
        vectors.av_parser_init = (int @codec_id) =>
        {
            ...
            vectors.av_parser_init = av_parser_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_parser_init_delegate>(av_parser_init_ptr);
        ...
        vectors.av_parser_iterate = (void** @opaque) =>
        {
            ...
            vectors.av_parser_iterate = av_parser_iterate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_parser_iterate_delegate>(av_parser_iterate_ptr);
        ...
        vectors.av_parser_parse2 = (AVCodecParserContext* @s, AVCodecContext* @avctx, byte** @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, long @pts, long @dts, long @pos) =>
        {
            ...
            vectors.av_parser_parse2 = av_parser_parse2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_parser_parse2_delegate>(av_parser_parse2_ptr);
        ...
        vectors.av_pix_fmt_count_planes = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.av_pix_fmt_count_planes = av_pix_fmt_count_planes_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_count_planes_delegate>(av_pix_fmt_count_planes_ptr);
        ...
        vectors.av_pix_fmt_desc_get = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.av_pix_fmt_desc_get = av_pix_fmt_desc_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_desc_get_delegate>(av_pix_fmt_desc_get_ptr);
        ...
        vectors.av_pix_fmt_desc_get_id = (AVPixFmtDescriptor* @desc) =>
        {
            ...
            vectors.av_pix_fmt_desc_get_id = av_pix_fmt_desc_get_id_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_desc_get_id_delegate>(av_pix_fmt_desc_get_id_ptr);
        ...
        vectors.av_pix_fmt_desc_next = (AVPixFmtDescriptor* @prev) =>
        {
            ...
            vectors.av_pix_fmt_desc_next = av_pix_fmt_desc_next_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_desc_next_delegate>(av_pix_fmt_desc_next_ptr);
        ...
        vectors.av_pix_fmt_get_chroma_sub_sample = (AVPixelFormat @pix_fmt, int* @h_shift, int* @v_shift) =>
        {
            ...
            vectors.av_pix_fmt_get_chroma_sub_sample = av_pix_fmt_get_chroma_sub_sample_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_get_chroma_sub_sample_delegate>(av_pix_fmt_get_chroma_sub_sample_ptr);
        ...
        vectors.av_pix_fmt_swap_endianness = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.av_pix_fmt_swap_endianness = av_pix_fmt_swap_endianness_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_pix_fmt_swap_endianness_delegate>(av_pix_fmt_swap_endianness_ptr);
        ...
        vectors.av_q2intfloat = (AVRational @q) =>
        {
            ...
            vectors.av_q2intfloat = av_q2intfloat_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_q2intfloat_delegate>(av_q2intfloat_ptr);
        ...
        vectors.av_read_frame = (AVFormatContext* @s, AVPacket* @pkt) =>
        {
            ...
            vectors.av_read_frame = av_read_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_read_frame_delegate>(av_read_frame_ptr);
        ...
        vectors.av_read_pause = (AVFormatContext* @s) =>
        {
            ...
            vectors.av_read_pause = av_read_pause_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_read_pause_delegate>(av_read_pause_ptr);
        ...
        vectors.av_read_play = (AVFormatContext* @s) =>
        {
            ...
            vectors.av_read_play = av_read_play_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_read_play_delegate>(av_read_play_ptr);
        ...
        vectors.av_realloc = (void* @ptr, ulong @size) =>
        {
            ...
            vectors.av_realloc = av_realloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_realloc_delegate>(av_realloc_ptr);
        ...
        vectors.av_realloc_array = (void* @ptr, ulong @nmemb, ulong @size) =>
        {
            ...
            vectors.av_realloc_array = av_realloc_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_realloc_array_delegate>(av_realloc_array_ptr);
        ...
        vectors.av_realloc_f = (void* @ptr, ulong @nelem, ulong @elsize) =>
        {
            ...
            vectors.av_realloc_f = av_realloc_f_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_realloc_f_delegate>(av_realloc_f_ptr);
        ...
        vectors.av_reallocp = (void* @ptr, ulong @size) =>
        {
            ...
            vectors.av_reallocp = av_reallocp_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_reallocp_delegate>(av_reallocp_ptr);
        ...
        vectors.av_reallocp_array = (void* @ptr, ulong @nmemb, ulong @size) =>
        {
            ...
            vectors.av_reallocp_array = av_reallocp_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_reallocp_array_delegate>(av_reallocp_array_ptr);
        ...
        vectors.av_reduce = (int* @dst_num, int* @dst_den, long @num, long @den, long @max) =>
        {
            ...
            vectors.av_reduce = av_reduce_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_reduce_delegate>(av_reduce_ptr);
        ...
        vectors.av_rescale = (long @a, long @b, long @c) =>
        {
            ...
            vectors.av_rescale = av_rescale_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_rescale_delegate>(av_rescale_ptr);
        ...
        vectors.av_rescale_delta = (AVRational @in_tb, long @in_ts, AVRational @fs_tb, int @duration, long* @last, AVRational @out_tb) =>
        {
            ...
            vectors.av_rescale_delta = av_rescale_delta_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_rescale_delta_delegate>(av_rescale_delta_ptr);
        ...
        vectors.av_rescale_q = (long @a, AVRational @bq, AVRational @cq) =>
        {
            ...
            vectors.av_rescale_q = av_rescale_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_rescale_q_delegate>(av_rescale_q_ptr);
        ...
        vectors.av_rescale_q_rnd = (long @a, AVRational @bq, AVRational @cq, AVRounding @rnd) =>
        {
            ...
            vectors.av_rescale_q_rnd = av_rescale_q_rnd_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_rescale_q_rnd_delegate>(av_rescale_q_rnd_ptr);
        ...
        vectors.av_rescale_rnd = (long @a, long @b, long @c, AVRounding @rnd) =>
        {
            ...
            vectors.av_rescale_rnd = av_rescale_rnd_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_rescale_rnd_delegate>(av_rescale_rnd_ptr);
        ...
        vectors.av_sample_fmt_is_planar = (AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_sample_fmt_is_planar = av_sample_fmt_is_planar_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_sample_fmt_is_planar_delegate>(av_sample_fmt_is_planar_ptr);
        ...
        vectors.av_samples_alloc = (byte** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) =>
        {
            ...
            vectors.av_samples_alloc = av_samples_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_alloc_delegate>(av_samples_alloc_ptr);
        ...
        vectors.av_samples_alloc_array_and_samples = (byte*** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) =>
        {
            ...
            vectors.av_samples_alloc_array_and_samples = av_samples_alloc_array_and_samples_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_alloc_array_and_samples_delegate>(av_samples_alloc_array_and_samples_ptr);
        ...
        vectors.av_samples_copy = (byte** @dst, byte** @src, int @dst_offset, int @src_offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_samples_copy = av_samples_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_copy_delegate>(av_samples_copy_ptr);
        ...
        vectors.av_samples_fill_arrays = (byte** @audio_data, int* @linesize, byte* @buf, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) =>
        {
            ...
            vectors.av_samples_fill_arrays = av_samples_fill_arrays_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_fill_arrays_delegate>(av_samples_fill_arrays_ptr);
        ...
        vectors.av_samples_get_buffer_size = (int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) =>
        {
            ...
            vectors.av_samples_get_buffer_size = av_samples_get_buffer_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_get_buffer_size_delegate>(av_samples_get_buffer_size_ptr);
        ...
        vectors.av_samples_set_silence = (byte** @audio_data, int @offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt) =>
        {
            ...
            vectors.av_samples_set_silence = av_samples_set_silence_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_samples_set_silence_delegate>(av_samples_set_silence_ptr);
        ...
        vectors.av_set_options_string = (void* @ctx, string @opts, string @key_val_sep, string @pairs_sep) =>
        {
            ...
            vectors.av_set_options_string = av_set_options_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_set_options_string_delegate>(av_set_options_string_ptr);
        ...
        vectors.av_size_mult = (ulong @a, ulong @b, ulong* @r) =>
        {
            ...
            vectors.av_size_mult = av_size_mult_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_size_mult_delegate>(av_size_mult_ptr);
        ...
        vectors.av_strdup = (string @s) =>
        {
            ...
            vectors.av_strdup = av_strdup_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_strdup_delegate>(av_strdup_ptr);
        ...
        vectors.av_strerror = (int @errnum, byte* @errbuf, ulong @errbuf_size) =>
        {
            ...
            vectors.av_strerror = av_strerror_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_strerror_delegate>(av_strerror_ptr);
        ...
        vectors.av_strndup = (string @s, ulong @len) =>
        {
            ...
            vectors.av_strndup = av_strndup_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_strndup_delegate>(av_strndup_ptr);
        ...
        vectors.av_sub_q = (AVRational @b, AVRational @c) =>
        {
            ...
            vectors.av_sub_q = av_sub_q_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_sub_q_delegate>(av_sub_q_ptr);
        ...
        vectors.av_timecode_adjust_ntsc_framenum2 = (int @framenum, int @fps) =>
        {
            ...
            vectors.av_timecode_adjust_ntsc_framenum2 = av_timecode_adjust_ntsc_framenum2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_adjust_ntsc_framenum2_delegate>(av_timecode_adjust_ntsc_framenum2_ptr);
        ...
        vectors.av_timecode_check_frame_rate = (AVRational @rate) =>
        {
            ...
            vectors.av_timecode_check_frame_rate = av_timecode_check_frame_rate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_check_frame_rate_delegate>(av_timecode_check_frame_rate_ptr);
        ...
        vectors.av_timecode_get_smpte = (AVRational @rate, int @drop, int @hh, int @mm, int @ss, int @ff) =>
        {
            ...
            vectors.av_timecode_get_smpte = av_timecode_get_smpte_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_get_smpte_delegate>(av_timecode_get_smpte_ptr);
        ...
        vectors.av_timecode_get_smpte_from_framenum = (AVTimecode* @tc, int @framenum) =>
        {
            ...
            vectors.av_timecode_get_smpte_from_framenum = av_timecode_get_smpte_from_framenum_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_get_smpte_from_framenum_delegate>(av_timecode_get_smpte_from_framenum_ptr);
        ...
        vectors.av_timecode_init = (AVTimecode* @tc, AVRational @rate, int @flags, int @frame_start, void* @log_ctx) =>
        {
            ...
            vectors.av_timecode_init = av_timecode_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_init_delegate>(av_timecode_init_ptr);
        ...
        vectors.av_timecode_init_from_components = (AVTimecode* @tc, AVRational @rate, int @flags, int @hh, int @mm, int @ss, int @ff, void* @log_ctx) =>
        {
            ...
            vectors.av_timecode_init_from_components = av_timecode_init_from_components_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_init_from_components_delegate>(av_timecode_init_from_components_ptr);
        ...
        vectors.av_timecode_init_from_string = (AVTimecode* @tc, AVRational @rate, string @str, void* @log_ctx) =>
        {
            ...
            vectors.av_timecode_init_from_string = av_timecode_init_from_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_init_from_string_delegate>(av_timecode_init_from_string_ptr);
        ...
        vectors.av_timecode_make_mpeg_tc_string = (byte* @buf, uint @tc25bit) =>
        {
            ...
            vectors.av_timecode_make_mpeg_tc_string = av_timecode_make_mpeg_tc_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_make_mpeg_tc_string_delegate>(av_timecode_make_mpeg_tc_string_ptr);
        ...
        vectors.av_timecode_make_smpte_tc_string = (byte* @buf, uint @tcsmpte, int @prevent_df) =>
        {
            ...
            vectors.av_timecode_make_smpte_tc_string = av_timecode_make_smpte_tc_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_make_smpte_tc_string_delegate>(av_timecode_make_smpte_tc_string_ptr);
        ...
        vectors.av_timecode_make_smpte_tc_string2 = (byte* @buf, AVRational @rate, uint @tcsmpte, int @prevent_df, int @skip_field) =>
        {
            ...
            vectors.av_timecode_make_smpte_tc_string2 = av_timecode_make_smpte_tc_string2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_make_smpte_tc_string2_delegate>(av_timecode_make_smpte_tc_string2_ptr);
        ...
        vectors.av_timecode_make_string = (AVTimecode* @tc, byte* @buf, int @framenum) =>
        {
            ...
            vectors.av_timecode_make_string = av_timecode_make_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_timecode_make_string_delegate>(av_timecode_make_string_ptr);
        ...
        vectors.av_tree_destroy = (AVTreeNode* @t) =>
        {
            ...
            vectors.av_tree_destroy = av_tree_destroy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_tree_destroy_delegate>(av_tree_destroy_ptr);
        ...
        vectors.av_tree_enumerate = (AVTreeNode* @t, void* @opaque, av_tree_enumerate_cmp_func @cmp, av_tree_enumerate_enu_func @enu) =>
        {
            ...
            vectors.av_tree_enumerate = av_tree_enumerate_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_tree_enumerate_delegate>(av_tree_enumerate_ptr);
        ...
        vectors.av_tree_find = (AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, ref void_ptrArray2 @next) =>
        {
            ...
            vectors.av_tree_find = av_tree_find_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_tree_find_delegate>(av_tree_find_ptr);
        ...
        vectors.av_tree_insert = (AVTreeNode** @rootp, void* @key, av_tree_insert_cmp_func @cmp, AVTreeNode** @next) =>
        {
            ...
            vectors.av_tree_insert = av_tree_insert_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_tree_insert_delegate>(av_tree_insert_ptr);
        ...
        vectors.av_tree_node_alloc = () =>
        {
            ...
            vectors.av_tree_node_alloc = av_tree_node_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_tree_node_alloc_delegate>(av_tree_node_alloc_ptr);
        ...
        vectors.av_usleep = (uint @usec) =>
        {
            ...
            vectors.av_usleep = av_usleep_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_usleep_delegate>(av_usleep_ptr);
        ...
        vectors.av_version_info = () =>
        {
            ...
            vectors.av_version_info = av_version_info_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_version_info_delegate>(av_version_info_ptr);
        ...
        vectors.av_vlog = (void* @avcl, int @level, string @fmt, byte* @vl) =>
        {
            ...
            vectors.av_vlog = av_vlog_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_vlog_delegate>(av_vlog_ptr);
        ...
        vectors.av_write_frame = (AVFormatContext* @s, AVPacket* @pkt) =>
        {
            ...
            vectors.av_write_frame = av_write_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_write_frame_delegate>(av_write_frame_ptr);
        ...
        vectors.av_write_trailer = (AVFormatContext* @s) =>
        {
            ...
            vectors.av_write_trailer = av_write_trailer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_write_trailer_delegate>(av_write_trailer_ptr);
        ...
        vectors.av_write_uncoded_frame = (AVFormatContext* @s, int @stream_index, AVFrame* @frame) =>
        {
            ...
            vectors.av_write_uncoded_frame = av_write_uncoded_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_write_uncoded_frame_delegate>(av_write_uncoded_frame_ptr);
        ...
        vectors.av_write_uncoded_frame_query = (AVFormatContext* @s, int @stream_index) =>
        {
            ...
            vectors.av_write_uncoded_frame_query = av_write_uncoded_frame_query_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.av_write_uncoded_frame_query_delegate>(av_write_uncoded_frame_query_ptr);
        ...
        vectors.avcodec_align_dimensions = (AVCodecContext* @s, int* @width, int* @height) =>
        {
            ...
            vectors.avcodec_align_dimensions = avcodec_align_dimensions_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_align_dimensions_delegate>(avcodec_align_dimensions_ptr);
        ...
        vectors.avcodec_align_dimensions2 = (AVCodecContext* @s, int* @width, int* @height, ref int_array8 @linesize_align) =>
        {
            ...
            vectors.avcodec_align_dimensions2 = avcodec_align_dimensions2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_align_dimensions2_delegate>(avcodec_align_dimensions2_ptr);
        ...
        vectors.avcodec_alloc_context3 = (AVCodec* @codec) =>
        {
            ...
            vectors.avcodec_alloc_context3 = avcodec_alloc_context3_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_alloc_context3_delegate>(avcodec_alloc_context3_ptr);
        ...
        vectors.avcodec_configuration = () =>
        {
            ...
            vectors.avcodec_configuration = avcodec_configuration_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_configuration_delegate>(avcodec_configuration_ptr);
        ...
        vectors.avcodec_decode_subtitle2 = (AVCodecContext* @avctx, AVSubtitle* @sub, int* @got_sub_ptr, AVPacket* @avpkt) =>
        {
            ...
            vectors.avcodec_decode_subtitle2 = avcodec_decode_subtitle2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_decode_subtitle2_delegate>(avcodec_decode_subtitle2_ptr);
        ...
        vectors.avcodec_default_execute = (AVCodecContext* @c, avcodec_default_execute_func_func @func, void* @arg, int* @ret, int @count, int @size) =>
        {
            ...
            vectors.avcodec_default_execute = avcodec_default_execute_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_default_execute_delegate>(avcodec_default_execute_ptr);
        ...
        vectors.avcodec_default_execute2 = (AVCodecContext* @c, avcodec_default_execute2_func_func @func, void* @arg, int* @ret, int @count) =>
        {
            ...
            vectors.avcodec_default_execute2 = avcodec_default_execute2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_default_execute2_delegate>(avcodec_default_execute2_ptr);
        ...
        vectors.avcodec_default_get_buffer2 = (AVCodecContext* @s, AVFrame* @frame, int @flags) =>
        {
            ...
            vectors.avcodec_default_get_buffer2 = avcodec_default_get_buffer2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_default_get_buffer2_delegate>(avcodec_default_get_buffer2_ptr);
        ...
        vectors.avcodec_default_get_encode_buffer = (AVCodecContext* @s, AVPacket* @pkt, int @flags) =>
        {
            ...
            vectors.avcodec_default_get_encode_buffer = avcodec_default_get_encode_buffer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_default_get_encode_buffer_delegate>(avcodec_default_get_encode_buffer_ptr);
        ...
        vectors.avcodec_default_get_format = (AVCodecContext* @s, AVPixelFormat* @fmt) =>
        {
            ...
            vectors.avcodec_default_get_format = avcodec_default_get_format_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_default_get_format_delegate>(avcodec_default_get_format_ptr);
        ...
        vectors.avcodec_descriptor_get = (AVCodecID @id) =>
        {
            ...
            vectors.avcodec_descriptor_get = avcodec_descriptor_get_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_descriptor_get_delegate>(avcodec_descriptor_get_ptr);
        ...
        vectors.avcodec_descriptor_get_by_name = (string @name) =>
        {
            ...
            vectors.avcodec_descriptor_get_by_name = avcodec_descriptor_get_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_descriptor_get_by_name_delegate>(avcodec_descriptor_get_by_name_ptr);
        ...
        vectors.avcodec_descriptor_next = (AVCodecDescriptor* @prev) =>
        {
            ...
            vectors.avcodec_descriptor_next = avcodec_descriptor_next_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_descriptor_next_delegate>(avcodec_descriptor_next_ptr);
        ...
        vectors.avcodec_encode_subtitle = (AVCodecContext* @avctx, byte* @buf, int @buf_size, AVSubtitle* @sub) =>
        {
            ...
            vectors.avcodec_encode_subtitle = avcodec_encode_subtitle_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_encode_subtitle_delegate>(avcodec_encode_subtitle_ptr);
        ...
        vectors.avcodec_fill_audio_frame = (AVFrame* @frame, int @nb_channels, AVSampleFormat @sample_fmt, byte* @buf, int @buf_size, int @align) =>
        {
            ...
            vectors.avcodec_fill_audio_frame = avcodec_fill_audio_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_fill_audio_frame_delegate>(avcodec_fill_audio_frame_ptr);
        ...
        vectors.avcodec_find_best_pix_fmt_of_list = (AVPixelFormat* @pix_fmt_list, AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) =>
        {
            ...
            vectors.avcodec_find_best_pix_fmt_of_list = avcodec_find_best_pix_fmt_of_list_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_find_best_pix_fmt_of_list_delegate>(avcodec_find_best_pix_fmt_of_list_ptr);
        ...
        vectors.avcodec_find_decoder = (AVCodecID @id) =>
        {
            ...
            vectors.avcodec_find_decoder = avcodec_find_decoder_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_find_decoder_delegate>(avcodec_find_decoder_ptr);
        ...
        vectors.avcodec_find_decoder_by_name = (string @name) =>
        {
            ...
            vectors.avcodec_find_decoder_by_name = avcodec_find_decoder_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_find_decoder_by_name_delegate>(avcodec_find_decoder_by_name_ptr);
        ...
        vectors.avcodec_find_encoder = (AVCodecID @id) =>
        {
            ...
            vectors.avcodec_find_encoder = avcodec_find_encoder_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_find_encoder_delegate>(avcodec_find_encoder_ptr);
        ...
        vectors.avcodec_find_encoder_by_name = (string @name) =>
        {
            ...
            vectors.avcodec_find_encoder_by_name = avcodec_find_encoder_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_find_encoder_by_name_delegate>(avcodec_find_encoder_by_name_ptr);
        ...
        vectors.avcodec_flush_buffers = (AVCodecContext* @avctx) =>
        {
            ...
            vectors.avcodec_flush_buffers = avcodec_flush_buffers_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_flush_buffers_delegate>(avcodec_flush_buffers_ptr);
        ...
        vectors.avcodec_free_context = (AVCodecContext** @avctx) =>
        {
            ...
            vectors.avcodec_free_context = avcodec_free_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_free_context_delegate>(avcodec_free_context_ptr);
        ...
        vectors.avcodec_get_class = () =>
        {
            ...
            vectors.avcodec_get_class = avcodec_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_class_delegate>(avcodec_get_class_ptr);
        ...
        vectors.avcodec_get_hw_config = (AVCodec* @codec, int @index) =>
        {
            ...
            vectors.avcodec_get_hw_config = avcodec_get_hw_config_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_hw_config_delegate>(avcodec_get_hw_config_ptr);
        ...
        vectors.avcodec_get_hw_frames_parameters = (AVCodecContext* @avctx, AVBufferRef* @device_ref, AVPixelFormat @hw_pix_fmt, AVBufferRef** @out_frames_ref) =>
        {
            ...
            vectors.avcodec_get_hw_frames_parameters = avcodec_get_hw_frames_parameters_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_hw_frames_parameters_delegate>(avcodec_get_hw_frames_parameters_ptr);
        ...
        vectors.avcodec_get_name = (AVCodecID @id) =>
        {
            ...
            vectors.avcodec_get_name = avcodec_get_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_name_delegate>(avcodec_get_name_ptr);
        ...
        vectors.avcodec_get_subtitle_rect_class = () =>
        {
            ...
            vectors.avcodec_get_subtitle_rect_class = avcodec_get_subtitle_rect_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_subtitle_rect_class_delegate>(avcodec_get_subtitle_rect_class_ptr);
        ...
        vectors.avcodec_get_supported_config = (AVCodecContext* @avctx, AVCodec* @codec, AVCodecConfig @config, uint @flags, void** @out_configs, int* @out_num_configs) =>
        {
            ...
            vectors.avcodec_get_supported_config = avcodec_get_supported_config_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_supported_config_delegate>(avcodec_get_supported_config_ptr);
        ...
        vectors.avcodec_get_type = (AVCodecID @codec_id) =>
        {
            ...
            vectors.avcodec_get_type = avcodec_get_type_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_get_type_delegate>(avcodec_get_type_ptr);
        ...
        vectors.avcodec_is_open = (AVCodecContext* @s) =>
        {
            ...
            vectors.avcodec_is_open = avcodec_is_open_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_is_open_delegate>(avcodec_is_open_ptr);
        ...
        vectors.avcodec_license = () =>
        {
            ...
            vectors.avcodec_license = avcodec_license_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_license_delegate>(avcodec_license_ptr);
        ...
        vectors.avcodec_open2 = (AVCodecContext* @avctx, AVCodec* @codec, AVDictionary** @options) =>
        {
            ...
            vectors.avcodec_open2 = avcodec_open2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_open2_delegate>(avcodec_open2_ptr);
        ...
        vectors.avcodec_parameters_alloc = () =>
        {
            ...
            vectors.avcodec_parameters_alloc = avcodec_parameters_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_parameters_alloc_delegate>(avcodec_parameters_alloc_ptr);
        ...
        vectors.avcodec_parameters_copy = (AVCodecParameters* @dst, AVCodecParameters* @src) =>
        {
            ...
            vectors.avcodec_parameters_copy = avcodec_parameters_copy_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_parameters_copy_delegate>(avcodec_parameters_copy_ptr);
        ...
        vectors.avcodec_parameters_free = (AVCodecParameters** @par) =>
        {
            ...
            vectors.avcodec_parameters_free = avcodec_parameters_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_parameters_free_delegate>(avcodec_parameters_free_ptr);
        ...
        vectors.avcodec_parameters_from_context = (AVCodecParameters* @par, AVCodecContext* @codec) =>
        {
            ...
            vectors.avcodec_parameters_from_context = avcodec_parameters_from_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_parameters_from_context_delegate>(avcodec_parameters_from_context_ptr);
        ...
        vectors.avcodec_parameters_to_context = (AVCodecContext* @codec, AVCodecParameters* @par) =>
        {
            ...
            vectors.avcodec_parameters_to_context = avcodec_parameters_to_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_parameters_to_context_delegate>(avcodec_parameters_to_context_ptr);
        ...
        vectors.avcodec_pix_fmt_to_codec_tag = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.avcodec_pix_fmt_to_codec_tag = avcodec_pix_fmt_to_codec_tag_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_pix_fmt_to_codec_tag_delegate>(avcodec_pix_fmt_to_codec_tag_ptr);
        ...
        vectors.avcodec_profile_name = (AVCodecID @codec_id, int @profile) =>
        {
            ...
            vectors.avcodec_profile_name = avcodec_profile_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_profile_name_delegate>(avcodec_profile_name_ptr);
        ...
        vectors.avcodec_receive_frame = (AVCodecContext* @avctx, AVFrame* @frame) =>
        {
            ...
            vectors.avcodec_receive_frame = avcodec_receive_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_receive_frame_delegate>(avcodec_receive_frame_ptr);
        ...
        vectors.avcodec_receive_packet = (AVCodecContext* @avctx, AVPacket* @avpkt) =>
        {
            ...
            vectors.avcodec_receive_packet = avcodec_receive_packet_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_receive_packet_delegate>(avcodec_receive_packet_ptr);
        ...
        vectors.avcodec_send_frame = (AVCodecContext* @avctx, AVFrame* @frame) =>
        {
            ...
            vectors.avcodec_send_frame = avcodec_send_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_send_frame_delegate>(avcodec_send_frame_ptr);
        ...
        vectors.avcodec_send_packet = (AVCodecContext* @avctx, AVPacket* @avpkt) =>
        {
            ...
            vectors.avcodec_send_packet = avcodec_send_packet_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_send_packet_delegate>(avcodec_send_packet_ptr);
        ...
        vectors.avcodec_string = (byte* @buf, int @buf_size, AVCodecContext* @enc, int @encode) =>
        {
            ...
            vectors.avcodec_string = avcodec_string_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_string_delegate>(avcodec_string_ptr);
        ...
        vectors.avcodec_version = () =>
        {
            ...
            vectors.avcodec_version = avcodec_version_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avcodec_version_delegate>(avcodec_version_ptr);
        ...
        vectors.avdevice_app_to_dev_control_message = (AVFormatContext* @s, AVAppToDevMessageType @type, void* @data, ulong @data_size) =>
        {
            ...
            vectors.avdevice_app_to_dev_control_message = avdevice_app_to_dev_control_message_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_app_to_dev_control_message_delegate>(avdevice_app_to_dev_control_message_ptr);
        ...
        vectors.avdevice_configuration = () =>
        {
            ...
            vectors.avdevice_configuration = avdevice_configuration_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_configuration_delegate>(avdevice_configuration_ptr);
        ...
        vectors.avdevice_dev_to_app_control_message = (AVFormatContext* @s, AVDevToAppMessageType @type, void* @data, ulong @data_size) =>
        {
            ...
            vectors.avdevice_dev_to_app_control_message = avdevice_dev_to_app_control_message_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_dev_to_app_control_message_delegate>(avdevice_dev_to_app_control_message_ptr);
        ...
        vectors.avdevice_free_list_devices = (AVDeviceInfoList** @device_list) =>
        {
            ...
            vectors.avdevice_free_list_devices = avdevice_free_list_devices_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_free_list_devices_delegate>(avdevice_free_list_devices_ptr);
        ...
        vectors.avdevice_license = () =>
        {
            ...
            vectors.avdevice_license = avdevice_license_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_license_delegate>(avdevice_license_ptr);
        ...
        vectors.avdevice_list_devices = (AVFormatContext* @s, AVDeviceInfoList** @device_list) =>
        {
            ...
            vectors.avdevice_list_devices = avdevice_list_devices_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_list_devices_delegate>(avdevice_list_devices_ptr);
        ...
        vectors.avdevice_list_input_sources = (AVInputFormat* @device, string @device_name, AVDictionary* @device_options, AVDeviceInfoList** @device_list) =>
        {
            ...
            vectors.avdevice_list_input_sources = avdevice_list_input_sources_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_list_input_sources_delegate>(avdevice_list_input_sources_ptr);
        ...
        vectors.avdevice_list_output_sinks = (AVOutputFormat* @device, string @device_name, AVDictionary* @device_options, AVDeviceInfoList** @device_list) =>
        {
            ...
            vectors.avdevice_list_output_sinks = avdevice_list_output_sinks_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_list_output_sinks_delegate>(avdevice_list_output_sinks_ptr);
        ...
        vectors.avdevice_register_all = () =>
        {
            ...
            vectors.avdevice_register_all = avdevice_register_all_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_register_all_delegate>(avdevice_register_all_ptr);
            vectors.avdevice_register_all();
        };
        ...
        vectors.avdevice_version = () =>
        {
            ...
            vectors.avdevice_version = avdevice_version_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avdevice_version_delegate>(avdevice_version_ptr);
        ...
        vectors.avfilter_configuration = () =>
        {
            ...
            vectors.avfilter_configuration = avfilter_configuration_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_configuration_delegate>(avfilter_configuration_ptr);
        ...
        vectors.avfilter_filter_pad_count = (AVFilter* @filter, int @is_output) =>
        {
            ...
            vectors.avfilter_filter_pad_count = avfilter_filter_pad_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_filter_pad_count_delegate>(avfilter_filter_pad_count_ptr);
        ...
        vectors.avfilter_free = (AVFilterContext* @filter) =>
        {
            ...
            vectors.avfilter_free = avfilter_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_free_delegate>(avfilter_free_ptr);
        ...
        vectors.avfilter_get_by_name = (string @name) =>
        {
            ...
            vectors.avfilter_get_by_name = avfilter_get_by_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_get_by_name_delegate>(avfilter_get_by_name_ptr);
        ...
        vectors.avfilter_get_class = () =>
        {
            ...
            vectors.avfilter_get_class = avfilter_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_get_class_delegate>(avfilter_get_class_ptr);
        ...
        vectors.avfilter_graph_alloc = () =>
        {
            ...
            vectors.avfilter_graph_alloc = avfilter_graph_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_alloc_delegate>(avfilter_graph_alloc_ptr);
        ...
        vectors.avfilter_graph_alloc_filter = (AVFilterGraph* @graph, AVFilter* @filter, string @name) =>
        {
            ...
            vectors.avfilter_graph_alloc_filter = avfilter_graph_alloc_filter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_alloc_filter_delegate>(avfilter_graph_alloc_filter_ptr);
        ...
        vectors.avfilter_graph_config = (AVFilterGraph* @graphctx, void* @log_ctx) =>
        {
            ...
            vectors.avfilter_graph_config = avfilter_graph_config_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_config_delegate>(avfilter_graph_config_ptr);
        ...
        vectors.avfilter_graph_create_filter = (AVFilterContext** @filt_ctx, AVFilter* @filt, string @name, string @args, void* @opaque, AVFilterGraph* @graph_ctx) =>
        {
            ...
            vectors.avfilter_graph_create_filter = avfilter_graph_create_filter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_create_filter_delegate>(avfilter_graph_create_filter_ptr);
        ...
        vectors.avfilter_graph_dump = (AVFilterGraph* @graph, string @options) =>
        {
            ...
            vectors.avfilter_graph_dump = avfilter_graph_dump_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_dump_delegate>(avfilter_graph_dump_ptr);
        ...
        vectors.avfilter_graph_free = (AVFilterGraph** @graph) =>
        {
            ...
            vectors.avfilter_graph_free = avfilter_graph_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_free_delegate>(avfilter_graph_free_ptr);
        ...
        vectors.avfilter_graph_get_filter = (AVFilterGraph* @graph, string @name) =>
        {
            ...
            vectors.avfilter_graph_get_filter = avfilter_graph_get_filter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_get_filter_delegate>(avfilter_graph_get_filter_ptr);
        ...
        vectors.avfilter_graph_parse = (AVFilterGraph* @graph, string @filters, AVFilterInOut* @inputs, AVFilterInOut* @outputs, void* @log_ctx) =>
        {
            ...
            vectors.avfilter_graph_parse = avfilter_graph_parse_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_parse_delegate>(avfilter_graph_parse_ptr);
        ...
        vectors.avfilter_graph_parse_ptr = (AVFilterGraph* @graph, string @filters, AVFilterInOut** @inputs, AVFilterInOut** @outputs, void* @log_ctx) =>
        {
            ...
            vectors.avfilter_graph_parse_ptr = avfilter_graph_parse_ptr_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_parse_ptr_delegate>(avfilter_graph_parse_ptr_ptr);
        ...
        vectors.avfilter_graph_parse2 = (AVFilterGraph* @graph, string @filters, AVFilterInOut** @inputs, AVFilterInOut** @outputs) =>
        {
            ...
            vectors.avfilter_graph_parse2 = avfilter_graph_parse2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_parse2_delegate>(avfilter_graph_parse2_ptr);
        ...
        vectors.avfilter_graph_queue_command = (AVFilterGraph* @graph, string @target, string @cmd, string @arg, int @flags, double @ts) =>
        {
            ...
            vectors.avfilter_graph_queue_command = avfilter_graph_queue_command_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_queue_command_delegate>(avfilter_graph_queue_command_ptr);
        ...
        vectors.avfilter_graph_request_oldest = (AVFilterGraph* @graph) =>
        {
            ...
            vectors.avfilter_graph_request_oldest = avfilter_graph_request_oldest_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_request_oldest_delegate>(avfilter_graph_request_oldest_ptr);
        ...
        vectors.avfilter_graph_segment_apply = (AVFilterGraphSegment* @seg, int @flags, AVFilterInOut** @inputs, AVFilterInOut** @outputs) =>
        {
            ...
            vectors.avfilter_graph_segment_apply = avfilter_graph_segment_apply_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_apply_delegate>(avfilter_graph_segment_apply_ptr);
        ...
        vectors.avfilter_graph_segment_apply_opts = (AVFilterGraphSegment* @seg, int @flags) =>
        {
            ...
            vectors.avfilter_graph_segment_apply_opts = avfilter_graph_segment_apply_opts_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_apply_opts_delegate>(avfilter_graph_segment_apply_opts_ptr);
        ...
        vectors.avfilter_graph_segment_create_filters = (AVFilterGraphSegment* @seg, int @flags) =>
        {
            ...
            vectors.avfilter_graph_segment_create_filters = avfilter_graph_segment_create_filters_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_create_filters_delegate>(avfilter_graph_segment_create_filters_ptr);
        ...
        vectors.avfilter_graph_segment_free = (AVFilterGraphSegment** @seg) =>
        {
            ...
            vectors.avfilter_graph_segment_free = avfilter_graph_segment_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_free_delegate>(avfilter_graph_segment_free_ptr);
        ...
        vectors.avfilter_graph_segment_init = (AVFilterGraphSegment* @seg, int @flags) =>
        {
            ...
            vectors.avfilter_graph_segment_init = avfilter_graph_segment_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_init_delegate>(avfilter_graph_segment_init_ptr);
        ...
        vectors.avfilter_graph_segment_link = (AVFilterGraphSegment* @seg, int @flags, AVFilterInOut** @inputs, AVFilterInOut** @outputs) =>
        {
            ...
            vectors.avfilter_graph_segment_link = avfilter_graph_segment_link_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_link_delegate>(avfilter_graph_segment_link_ptr);
        ...
        vectors.avfilter_graph_segment_parse = (AVFilterGraph* @graph, string @graph_str, int @flags, AVFilterGraphSegment** @seg) =>
        {
            ...
            vectors.avfilter_graph_segment_parse = avfilter_graph_segment_parse_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_segment_parse_delegate>(avfilter_graph_segment_parse_ptr);
        ...
        vectors.avfilter_graph_send_command = (AVFilterGraph* @graph, string @target, string @cmd, string @arg, byte* @res, int @res_len, int @flags) =>
        {
            ...
            vectors.avfilter_graph_send_command = avfilter_graph_send_command_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_send_command_delegate>(avfilter_graph_send_command_ptr);
        ...
        vectors.avfilter_graph_set_auto_convert = (AVFilterGraph* @graph, uint @flags) =>
        {
            ...
            vectors.avfilter_graph_set_auto_convert = avfilter_graph_set_auto_convert_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_graph_set_auto_convert_delegate>(avfilter_graph_set_auto_convert_ptr);
        ...
        vectors.avfilter_init_dict = (AVFilterContext* @ctx, AVDictionary** @options) =>
        {
            ...
            vectors.avfilter_init_dict = avfilter_init_dict_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_init_dict_delegate>(avfilter_init_dict_ptr);
        ...
        vectors.avfilter_init_str = (AVFilterContext* @ctx, string @args) =>
        {
            ...
            vectors.avfilter_init_str = avfilter_init_str_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_init_str_delegate>(avfilter_init_str_ptr);
        ...
        vectors.avfilter_inout_alloc = () =>
        {
            ...
            vectors.avfilter_inout_alloc = avfilter_inout_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_inout_alloc_delegate>(avfilter_inout_alloc_ptr);
        ...
        vectors.avfilter_inout_free = (AVFilterInOut** @inout) =>
        {
            ...
            vectors.avfilter_inout_free = avfilter_inout_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_inout_free_delegate>(avfilter_inout_free_ptr);
        ...
        vectors.avfilter_insert_filter = (AVFilterLink* @link, AVFilterContext* @filt, uint @filt_srcpad_idx, uint @filt_dstpad_idx) =>
        {
            ...
            vectors.avfilter_insert_filter = avfilter_insert_filter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_insert_filter_delegate>(avfilter_insert_filter_ptr);
        ...
        vectors.avfilter_license = () =>
        {
            ...
            vectors.avfilter_license = avfilter_license_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_license_delegate>(avfilter_license_ptr);
        ...
        vectors.avfilter_link = (AVFilterContext* @src, uint @srcpad, AVFilterContext* @dst, uint @dstpad) =>
        {
            ...
            vectors.avfilter_link = avfilter_link_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_link_delegate>(avfilter_link_ptr);
        ...
        vectors.avfilter_link_get_hw_frames_ctx = (AVFilterLink* @link) =>
        {
            ...
            vectors.avfilter_link_get_hw_frames_ctx = avfilter_link_get_hw_frames_ctx_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_link_get_hw_frames_ctx_delegate>(avfilter_link_get_hw_frames_ctx_ptr);
        ...
        vectors.avfilter_pad_get_name = (AVFilterPad* @pads, int @pad_idx) =>
        {
            ...
            vectors.avfilter_pad_get_name = avfilter_pad_get_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_pad_get_name_delegate>(avfilter_pad_get_name_ptr);
        ...
        vectors.avfilter_pad_get_type = (AVFilterPad* @pads, int @pad_idx) =>
        {
            ...
            vectors.avfilter_pad_get_type = avfilter_pad_get_type_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_pad_get_type_delegate>(avfilter_pad_get_type_ptr);
        ...
        vectors.avfilter_process_command = (AVFilterContext* @filter, string @cmd, string @arg, byte* @res, int @res_len, int @flags) =>
        {
            ...
            vectors.avfilter_process_command = avfilter_process_command_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_process_command_delegate>(avfilter_process_command_ptr);
        ...
        vectors.avfilter_version = () =>
        {
            ...
            vectors.avfilter_version = avfilter_version_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avfilter_version_delegate>(avfilter_version_ptr);
        ...
        vectors.avformat_alloc_context = () =>
        {
            ...
            vectors.avformat_alloc_context = avformat_alloc_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_alloc_context_delegate>(avformat_alloc_context_ptr);
        ...
        vectors.avformat_alloc_output_context2 = (AVFormatContext** @ctx, AVOutputFormat* @oformat, string @format_name, string @filename) =>
        {
            ...
            vectors.avformat_alloc_output_context2 = avformat_alloc_output_context2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_alloc_output_context2_delegate>(avformat_alloc_output_context2_ptr);
        ...
        vectors.avformat_close_input = (AVFormatContext** @s) =>
        {
            ...
            vectors.avformat_close_input = avformat_close_input_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_close_input_delegate>(avformat_close_input_ptr);
        ...
        vectors.avformat_configuration = () =>
        {
            ...
            vectors.avformat_configuration = avformat_configuration_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_configuration_delegate>(avformat_configuration_ptr);
        ...
        vectors.avformat_find_stream_info = (AVFormatContext* @ic, AVDictionary** @options) =>
        {
            ...
            vectors.avformat_find_stream_info = avformat_find_stream_info_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_find_stream_info_delegate>(avformat_find_stream_info_ptr);
        ...
        vectors.avformat_flush = (AVFormatContext* @s) =>
        {
            ...
            vectors.avformat_flush = avformat_flush_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_flush_delegate>(avformat_flush_ptr);
        ...
        vectors.avformat_free_context = (AVFormatContext* @s) =>
        {
            ...
            vectors.avformat_free_context = avformat_free_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_free_context_delegate>(avformat_free_context_ptr);
        ...
        vectors.avformat_get_class = () =>
        {
            ...
            vectors.avformat_get_class = avformat_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_get_class_delegate>(avformat_get_class_ptr);
        ...
        vectors.avformat_get_mov_audio_tags = () =>
        {
            ...
            vectors.avformat_get_mov_audio_tags = avformat_get_mov_audio_tags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_get_mov_audio_tags_delegate>(avformat_get_mov_audio_tags_ptr);
        ...
        vectors.avformat_get_mov_video_tags = () =>
        {
            ...
            vectors.avformat_get_mov_video_tags = avformat_get_mov_video_tags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_get_mov_video_tags_delegate>(avformat_get_mov_video_tags_ptr);
        ...
        vectors.avformat_get_riff_audio_tags = () =>
        {
            ...
            vectors.avformat_get_riff_audio_tags = avformat_get_riff_audio_tags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_get_riff_audio_tags_delegate>(avformat_get_riff_audio_tags_ptr);
        ...
        vectors.avformat_get_riff_video_tags = () =>
        {
            ...
            vectors.avformat_get_riff_video_tags = avformat_get_riff_video_tags_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_get_riff_video_tags_delegate>(avformat_get_riff_video_tags_ptr);
        ...
        vectors.avformat_index_get_entries_count = (AVStream* @st) =>
        {
            ...
            vectors.avformat_index_get_entries_count = avformat_index_get_entries_count_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_index_get_entries_count_delegate>(avformat_index_get_entries_count_ptr);
        ...
        vectors.avformat_index_get_entry = (AVStream* @st, int @idx) =>
        {
            ...
            vectors.avformat_index_get_entry = avformat_index_get_entry_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_index_get_entry_delegate>(avformat_index_get_entry_ptr);
        ...
        vectors.avformat_index_get_entry_from_timestamp = (AVStream* @st, long @wanted_timestamp, int @flags) =>
        {
            ...
            vectors.avformat_index_get_entry_from_timestamp = avformat_index_get_entry_from_timestamp_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_index_get_entry_from_timestamp_delegate>(avformat_index_get_entry_from_timestamp_ptr);
        ...
        vectors.avformat_init_output = (AVFormatContext* @s, AVDictionary** @options) =>
        {
            ...
            vectors.avformat_init_output = avformat_init_output_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_init_output_delegate>(avformat_init_output_ptr);
        ...
        vectors.avformat_license = () =>
        {
            ...
            vectors.avformat_license = avformat_license_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_license_delegate>(avformat_license_ptr);
        ...
        vectors.avformat_match_stream_specifier = (AVFormatContext* @s, AVStream* @st, string @spec) =>
        {
            ...
            vectors.avformat_match_stream_specifier = avformat_match_stream_specifier_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_match_stream_specifier_delegate>(avformat_match_stream_specifier_ptr);
        ...
        vectors.avformat_network_deinit = () =>
        {
            ...
            vectors.avformat_network_deinit = avformat_network_deinit_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_network_deinit_delegate>(avformat_network_deinit_ptr);
        ...
        vectors.avformat_network_init = () =>
        {
            ...
            vectors.avformat_network_init = avformat_network_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_network_init_delegate>(avformat_network_init_ptr);
        ...
        vectors.avformat_new_stream = (AVFormatContext* @s, AVCodec* @c) =>
        {
            ...
            vectors.avformat_new_stream = avformat_new_stream_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_new_stream_delegate>(avformat_new_stream_ptr);
        ...
        vectors.avformat_open_input = (AVFormatContext** @ps, string @url, AVInputFormat* @fmt, AVDictionary** @options) =>
        {
            ...
            vectors.avformat_open_input = avformat_open_input_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_open_input_delegate>(avformat_open_input_ptr);
        ...
        vectors.avformat_query_codec = (AVOutputFormat* @ofmt, AVCodecID @codec_id, int @std_compliance) =>
        {
            ...
            vectors.avformat_query_codec = avformat_query_codec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_query_codec_delegate>(avformat_query_codec_ptr);
        ...
        vectors.avformat_queue_attached_pictures = (AVFormatContext* @s) =>
        {
            ...
            vectors.avformat_queue_attached_pictures = avformat_queue_attached_pictures_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_queue_attached_pictures_delegate>(avformat_queue_attached_pictures_ptr);
        ...
        vectors.avformat_seek_file = (AVFormatContext* @s, int @stream_index, long @min_ts, long @ts, long @max_ts, int @flags) =>
        {
            ...
            vectors.avformat_seek_file = avformat_seek_file_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_seek_file_delegate>(avformat_seek_file_ptr);
        ...
        vectors.avformat_stream_group_add_stream = (AVStreamGroup* @stg, AVStream* @st) =>
        {
            ...
            vectors.avformat_stream_group_add_stream = avformat_stream_group_add_stream_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_stream_group_add_stream_delegate>(avformat_stream_group_add_stream_ptr);
        ...
        vectors.avformat_stream_group_create = (AVFormatContext* @s, AVStreamGroupParamsType @type, AVDictionary** @options) =>
        {
            ...
            vectors.avformat_stream_group_create = avformat_stream_group_create_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_stream_group_create_delegate>(avformat_stream_group_create_ptr);
        ...
        vectors.avformat_stream_group_name = (AVStreamGroupParamsType @type) =>
        {
            ...
            vectors.avformat_stream_group_name = avformat_stream_group_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_stream_group_name_delegate>(avformat_stream_group_name_ptr);
        ...
        vectors.avformat_transfer_internal_stream_timing_info = (AVOutputFormat* @ofmt, AVStream* @ost, AVStream* @ist, AVTimebaseSource @copy_tb) =>
        {
            ...
            vectors.avformat_transfer_internal_stream_timing_info = avformat_transfer_internal_stream_timing_info_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_transfer_internal_stream_timing_info_delegate>(avformat_transfer_internal_stream_timing_info_ptr);
        ...
        vectors.avformat_version = () =>
        {
            ...
            vectors.avformat_version = avformat_version_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_version_delegate>(avformat_version_ptr);
        ...
        vectors.avformat_write_header = (AVFormatContext* @s, AVDictionary** @options) =>
        {
            ...
            vectors.avformat_write_header = avformat_write_header_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avformat_write_header_delegate>(avformat_write_header_ptr);
        ...
        vectors.avio_accept = (AVIOContext* @s, AVIOContext** @c) =>
        {
            ...
            vectors.avio_accept = avio_accept_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_accept_delegate>(avio_accept_ptr);
        ...
        vectors.avio_alloc_context = (byte* @buffer, int @buffer_size, int @write_flag, void* @opaque, avio_alloc_context_read_packet_func @read_packet, avio_alloc_context_write_packet_func @write_packet, avio_alloc_context_seek_func @seek) =>
        {
            ...
            vectors.avio_alloc_context = avio_alloc_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_alloc_context_delegate>(avio_alloc_context_ptr);
        ...
        vectors.avio_check = (string @url, int @flags) =>
        {
            ...
            vectors.avio_check = avio_check_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_check_delegate>(avio_check_ptr);
        ...
        vectors.avio_close = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_close = avio_close_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_close_delegate>(avio_close_ptr);
        ...
        vectors.avio_close_dir = (AVIODirContext** @s) =>
        {
            ...
            vectors.avio_close_dir = avio_close_dir_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_close_dir_delegate>(avio_close_dir_ptr);
        ...
        vectors.avio_close_dyn_buf = (AVIOContext* @s, byte** @pbuffer) =>
        {
            ...
            vectors.avio_close_dyn_buf = avio_close_dyn_buf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_close_dyn_buf_delegate>(avio_close_dyn_buf_ptr);
        ...
        vectors.avio_closep = (AVIOContext** @s) =>
        {
            ...
            vectors.avio_closep = avio_closep_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_closep_delegate>(avio_closep_ptr);
        ...
        vectors.avio_context_free = (AVIOContext** @s) =>
        {
            ...
            vectors.avio_context_free = avio_context_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_context_free_delegate>(avio_context_free_ptr);
        ...
        vectors.avio_enum_protocols = (void** @opaque, int @output) =>
        {
            ...
            vectors.avio_enum_protocols = avio_enum_protocols_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_enum_protocols_delegate>(avio_enum_protocols_ptr);
        ...
        vectors.avio_feof = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_feof = avio_feof_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_feof_delegate>(avio_feof_ptr);
        ...
        vectors.avio_find_protocol_name = (string @url) =>
        {
            ...
            vectors.avio_find_protocol_name = avio_find_protocol_name_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_find_protocol_name_delegate>(avio_find_protocol_name_ptr);
        ...
        vectors.avio_flush = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_flush = avio_flush_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_flush_delegate>(avio_flush_ptr);
        ...
        vectors.avio_free_directory_entry = (AVIODirEntry** @entry) =>
        {
            ...
            vectors.avio_free_directory_entry = avio_free_directory_entry_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_free_directory_entry_delegate>(avio_free_directory_entry_ptr);
        ...
        vectors.avio_get_dyn_buf = (AVIOContext* @s, byte** @pbuffer) =>
        {
            ...
            vectors.avio_get_dyn_buf = avio_get_dyn_buf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_get_dyn_buf_delegate>(avio_get_dyn_buf_ptr);
        ...
        vectors.avio_get_str = (AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) =>
        {
            ...
            vectors.avio_get_str = avio_get_str_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_get_str_delegate>(avio_get_str_ptr);
        ...
        vectors.avio_get_str16be = (AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) =>
        {
            ...
            vectors.avio_get_str16be = avio_get_str16be_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_get_str16be_delegate>(avio_get_str16be_ptr);
        ...
        vectors.avio_get_str16le = (AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) =>
        {
            ...
            vectors.avio_get_str16le = avio_get_str16le_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_get_str16le_delegate>(avio_get_str16le_ptr);
        ...
        vectors.avio_handshake = (AVIOContext* @c) =>
        {
            ...
            vectors.avio_handshake = avio_handshake_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_handshake_delegate>(avio_handshake_ptr);
        ...
        vectors.avio_open = (AVIOContext** @s, string @url, int @flags) =>
        {
            ...
            vectors.avio_open = avio_open_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_open_delegate>(avio_open_ptr);
        ...
        vectors.avio_open_dir = (AVIODirContext** @s, string @url, AVDictionary** @options) =>
        {
            ...
            vectors.avio_open_dir = avio_open_dir_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_open_dir_delegate>(avio_open_dir_ptr);
        ...
        vectors.avio_open_dyn_buf = (AVIOContext** @s) =>
        {
            ...
            vectors.avio_open_dyn_buf = avio_open_dyn_buf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_open_dyn_buf_delegate>(avio_open_dyn_buf_ptr);
        ...
        vectors.avio_open2 = (AVIOContext** @s, string @url, int @flags, AVIOInterruptCB* @int_cb, AVDictionary** @options) =>
        {
            ...
            vectors.avio_open2 = avio_open2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_open2_delegate>(avio_open2_ptr);
        ...
        vectors.avio_pause = (AVIOContext* @h, int @pause) =>
        {
            ...
            vectors.avio_pause = avio_pause_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_pause_delegate>(avio_pause_ptr);
        ...
        vectors.avio_print_string_array = (AVIOContext* @s, byte*[] @strings) =>
        {
            ...
            vectors.avio_print_string_array = avio_print_string_array_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_print_string_array_delegate>(avio_print_string_array_ptr);
        ...
        vectors.avio_printf = (AVIOContext* @s, string @fmt) =>
        {
            ...
            vectors.avio_printf = avio_printf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_printf_delegate>(avio_printf_ptr);
        ...
        vectors.avio_protocol_get_class = (string @name) =>
        {
            ...
            vectors.avio_protocol_get_class = avio_protocol_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_protocol_get_class_delegate>(avio_protocol_get_class_ptr);
        ...
        vectors.avio_put_str = (AVIOContext* @s, string @str) =>
        {
            ...
            vectors.avio_put_str = avio_put_str_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_put_str_delegate>(avio_put_str_ptr);
        ...
        vectors.avio_put_str16be = (AVIOContext* @s, string @str) =>
        {
            ...
            vectors.avio_put_str16be = avio_put_str16be_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_put_str16be_delegate>(avio_put_str16be_ptr);
        ...
        vectors.avio_put_str16le = (AVIOContext* @s, string @str) =>
        {
            ...
            vectors.avio_put_str16le = avio_put_str16le_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_put_str16le_delegate>(avio_put_str16le_ptr);
        ...
        vectors.avio_r8 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_r8 = avio_r8_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_r8_delegate>(avio_r8_ptr);
        ...
        vectors.avio_rb16 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rb16 = avio_rb16_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rb16_delegate>(avio_rb16_ptr);
        ...
        vectors.avio_rb24 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rb24 = avio_rb24_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rb24_delegate>(avio_rb24_ptr);
        ...
        vectors.avio_rb32 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rb32 = avio_rb32_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rb32_delegate>(avio_rb32_ptr);
        ...
        vectors.avio_rb64 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rb64 = avio_rb64_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rb64_delegate>(avio_rb64_ptr);
        ...
        vectors.avio_read = (AVIOContext* @s, byte* @buf, int @size) =>
        {
            ...
            vectors.avio_read = avio_read_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_read_delegate>(avio_read_ptr);
        ...
        vectors.avio_read_dir = (AVIODirContext* @s, AVIODirEntry** @next) =>
        {
            ...
            vectors.avio_read_dir = avio_read_dir_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_read_dir_delegate>(avio_read_dir_ptr);
        ...
        vectors.avio_read_partial = (AVIOContext* @s, byte* @buf, int @size) =>
        {
            ...
            vectors.avio_read_partial = avio_read_partial_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_read_partial_delegate>(avio_read_partial_ptr);
        ...
        vectors.avio_read_to_bprint = (AVIOContext* @h, AVBPrint* @pb, ulong @max_size) =>
        {
            ...
            vectors.avio_read_to_bprint = avio_read_to_bprint_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_read_to_bprint_delegate>(avio_read_to_bprint_ptr);
        ...
        vectors.avio_rl16 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rl16 = avio_rl16_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rl16_delegate>(avio_rl16_ptr);
        ...
        vectors.avio_rl24 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rl24 = avio_rl24_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rl24_delegate>(avio_rl24_ptr);
        ...
        vectors.avio_rl32 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rl32 = avio_rl32_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rl32_delegate>(avio_rl32_ptr);
        ...
        vectors.avio_rl64 = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_rl64 = avio_rl64_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_rl64_delegate>(avio_rl64_ptr);
        ...
        vectors.avio_seek = (AVIOContext* @s, long @offset, int @whence) =>
        {
            ...
            vectors.avio_seek = avio_seek_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_seek_delegate>(avio_seek_ptr);
        ...
        vectors.avio_seek_time = (AVIOContext* @h, int @stream_index, long @timestamp, int @flags) =>
        {
            ...
            vectors.avio_seek_time = avio_seek_time_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_seek_time_delegate>(avio_seek_time_ptr);
        ...
        vectors.avio_size = (AVIOContext* @s) =>
        {
            ...
            vectors.avio_size = avio_size_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_size_delegate>(avio_size_ptr);
        ...
        vectors.avio_skip = (AVIOContext* @s, long @offset) =>
        {
            ...
            vectors.avio_skip = avio_skip_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_skip_delegate>(avio_skip_ptr);
        ...
        vectors.avio_vprintf = (AVIOContext* @s, string @fmt, byte* @ap) =>
        {
            ...
            vectors.avio_vprintf = avio_vprintf_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_vprintf_delegate>(avio_vprintf_ptr);
        ...
        vectors.avio_w8 = (AVIOContext* @s, int @b) =>
        {
            ...
            vectors.avio_w8 = avio_w8_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_w8_delegate>(avio_w8_ptr);
            vectors.avio_w8(@s, @b);
        };
        ...
        vectors.avio_wb16 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wb16 = avio_wb16_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wb16_delegate>(avio_wb16_ptr);
        ...
        vectors.avio_wb24 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wb24 = avio_wb24_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wb24_delegate>(avio_wb24_ptr);
        ...
        vectors.avio_wb32 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wb32 = avio_wb32_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wb32_delegate>(avio_wb32_ptr);
        ...
        vectors.avio_wb64 = (AVIOContext* @s, ulong @val) =>
        {
            ...
            vectors.avio_wb64 = avio_wb64_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wb64_delegate>(avio_wb64_ptr);
        ...
        vectors.avio_wl16 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wl16 = avio_wl16_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wl16_delegate>(avio_wl16_ptr);
        ...
        vectors.avio_wl24 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wl24 = avio_wl24_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wl24_delegate>(avio_wl24_ptr);
        ...
        vectors.avio_wl32 = (AVIOContext* @s, uint @val) =>
        {
            ...
            vectors.avio_wl32 = avio_wl32_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wl32_delegate>(avio_wl32_ptr);
        ...
        vectors.avio_wl64 = (AVIOContext* @s, ulong @val) =>
        {
            ...
            vectors.avio_wl64 = avio_wl64_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_wl64_delegate>(avio_wl64_ptr);
        ...
        vectors.avio_write = (AVIOContext* @s, byte* @buf, int @size) =>
        {
            ...
            vectors.avio_write = avio_write_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_write_delegate>(avio_write_ptr);
        ...
        vectors.avio_write_marker = (AVIOContext* @s, long @time, AVIODataMarkerType @type) =>
        {
            ...
            vectors.avio_write_marker = avio_write_marker_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avio_write_marker_delegate>(avio_write_marker_ptr);
        ...
        vectors.avutil_configuration = () =>
        {
            ...
            vectors.avutil_configuration = avutil_configuration_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avutil_configuration_delegate>(avutil_configuration_ptr);
        ...
        vectors.avutil_license = () =>
        {
            ...
            vectors.avutil_license = avutil_license_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avutil_license_delegate>(avutil_license_ptr);
        ...
        vectors.avutil_version = () =>
        {
            ...
            vectors.avutil_version = avutil_version_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.avutil_version_delegate>(avutil_version_ptr);
        ...
        vectors.swr_alloc = () =>
        {
            ...
            vectors.swr_alloc = swr_alloc_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_alloc_delegate>(swr_alloc_ptr);
        ...
        vectors.swr_alloc_set_opts2 = (SwrContext** @ps, AVChannelLayout* @out_ch_layout, AVSampleFormat @out_sample_fmt, int @out_sample_rate, AVChannelLayout* @in_ch_layout, AVSampleFormat @in_sample_fmt, int @in_sample_rate, int @log_offset, void* @log_ctx) =>
        {
            ...
            vectors.swr_alloc_set_opts2 = swr_alloc_set_opts2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_alloc_set_opts2_delegate>(swr_alloc_set_opts2_ptr);
        ...
        vectors.swr_build_matrix2 = (AVChannelLayout* @in_layout, AVChannelLayout* @out_layout, double @center_mix_level, double @surround_mix_level, double @lfe_mix_level, double @maxval, double @rematrix_volume, double* @matrix, long @stride, AVMatrixEncoding @matrix_encoding, void* @log_context) =>
        {
            ...
            vectors.swr_build_matrix2 = swr_build_matrix2_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_build_matrix2_delegate>(swr_build_matrix2_ptr);
        ...
        vectors.swr_close = (SwrContext* @s) =>
        {
            ...
            vectors.swr_close = swr_close_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_close_delegate>(swr_close_ptr);
            vectors.swr_close(@s);
        };
        ...
        vectors.swr_config_frame = (SwrContext* @swr, AVFrame* @out, AVFrame* @in) =>
        {
            ...
            vectors.swr_config_frame = swr_config_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_config_frame_delegate>(swr_config_frame_ptr);
        ...
        vectors.swr_convert = (SwrContext* @s, byte** @out, int @out_count, byte** @in, int @in_count) =>
        {
            ...
            vectors.swr_convert = swr_convert_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_convert_delegate>(swr_convert_ptr);
        ...
        vectors.swr_convert_frame = (SwrContext* @swr, AVFrame* @output, AVFrame* @input) =>
        {
            ...
            vectors.swr_convert_frame = swr_convert_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_convert_frame_delegate>(swr_convert_frame_ptr);
        ...
        vectors.swr_drop_output = (SwrContext* @s, int @count) =>
        {
            ...
            vectors.swr_drop_output = swr_drop_output_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_drop_output_delegate>(swr_drop_output_ptr);
        ...
        vectors.swr_free = (SwrContext** @s) =>
        {
            ...
            vectors.swr_free = swr_free_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_free_delegate>(swr_free_ptr);
            vectors.swr_free(@s);
        };
        ...
        vectors.swr_get_class = () =>
        {
            ...
            vectors.swr_get_class = swr_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_get_class_delegate>(swr_get_class_ptr);
        ...
        vectors.swr_get_delay = (SwrContext* @s, long @base) =>
        {
            ...
            vectors.swr_get_delay = swr_get_delay_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_get_delay_delegate>(swr_get_delay_ptr);
        ...
        vectors.swr_get_out_samples = (SwrContext* @s, int @in_samples) =>
        {
            ...
            vectors.swr_get_out_samples = swr_get_out_samples_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_get_out_samples_delegate>(swr_get_out_samples_ptr);
        ...
        vectors.swr_init = (SwrContext* @s) =>
        {
            ...
            vectors.swr_init = swr_init_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_init_delegate>(swr_init_ptr);
        ...
        vectors.swr_inject_silence = (SwrContext* @s, int @count) =>
        {
            ...
            vectors.swr_inject_silence = swr_inject_silence_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_inject_silence_delegate>(swr_inject_silence_ptr);
        ...
        vectors.swr_is_initialized = (SwrContext* @s) =>
        {
            ...
            vectors.swr_is_initialized = swr_is_initialized_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_is_initialized_delegate>(swr_is_initialized_ptr);
        ...
        vectors.swr_next_pts = (SwrContext* @s, long @pts) =>
        {
            ...
            vectors.swr_next_pts = swr_next_pts_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_next_pts_delegate>(swr_next_pts_ptr);
        ...
        vectors.swr_set_channel_mapping = (SwrContext* @s, int* @channel_map) =>
        {
            ...
            vectors.swr_set_channel_mapping = swr_set_channel_mapping_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_set_channel_mapping_delegate>(swr_set_channel_mapping_ptr);
        ...
        vectors.swr_set_compensation = (SwrContext* @s, int @sample_delta, int @compensation_distance) =>
        {
            ...
            vectors.swr_set_compensation = swr_set_compensation_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_set_compensation_delegate>(swr_set_compensation_ptr);
        ...
        vectors.swr_set_matrix = (SwrContext* @s, double* @matrix, int @stride) =>
        {
            ...
            vectors.swr_set_matrix = swr_set_matrix_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.swr_set_matrix_delegate>(swr_set_matrix_ptr);
        ...
        vectors.sws_alloc_context = () =>
        {
            ...
            vectors.sws_alloc_context = sws_alloc_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_alloc_context_delegate>(sws_alloc_context_ptr);
        ...
        vectors.sws_allocVec = (int @length) =>
        {
            ...
            vectors.sws_allocVec = sws_allocVec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_allocVec_delegate>(sws_allocVec_ptr);
        ...
        vectors.sws_convertPalette8ToPacked24 = (byte* @src, byte* @dst, int @num_pixels, byte* @palette) =>
        {
            ...
            vectors.sws_convertPalette8ToPacked24 = sws_convertPalette8ToPacked24_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_convertPalette8ToPacked24_delegate>(sws_convertPalette8ToPacked24_ptr);
        ...
        vectors.sws_convertPalette8ToPacked32 = (byte* @src, byte* @dst, int @num_pixels, byte* @palette) =>
        {
            ...
            vectors.sws_convertPalette8ToPacked32 = sws_convertPalette8ToPacked32_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_convertPalette8ToPacked32_delegate>(sws_convertPalette8ToPacked32_ptr);
        ...
        vectors.sws_frame_end = (SwsContext* @c) =>
        {
            ...
            vectors.sws_frame_end = sws_frame_end_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_frame_end_delegate>(sws_frame_end_ptr);
        ...
        vectors.sws_frame_setup = (SwsContext* @ctx, AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.sws_frame_setup = sws_frame_setup_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_frame_setup_delegate>(sws_frame_setup_ptr);
        ...
        vectors.sws_frame_start = (SwsContext* @c, AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.sws_frame_start = sws_frame_start_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_frame_start_delegate>(sws_frame_start_ptr);
        ...
        vectors.sws_free_context = (SwsContext** @ctx) =>
        {
            ...
            vectors.sws_free_context = sws_free_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_free_context_delegate>(sws_free_context_ptr);
        ...
        vectors.sws_freeContext = (SwsContext* @swsContext) =>
        {
            ...
            vectors.sws_freeContext = sws_freeContext_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_freeContext_delegate>(sws_freeContext_ptr);
        ...
        vectors.sws_freeFilter = (SwsFilter* @filter) =>
        {
            ...
            vectors.sws_freeFilter = sws_freeFilter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_freeFilter_delegate>(sws_freeFilter_ptr);
        ...
        vectors.sws_freeVec = (SwsVector* @a) =>
        {
            ...
            vectors.sws_freeVec = sws_freeVec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_freeVec_delegate>(sws_freeVec_ptr);
        ...
        vectors.sws_get_class = () =>
        {
            ...
            vectors.sws_get_class = sws_get_class_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_get_class_delegate>(sws_get_class_ptr);
        ...
        vectors.sws_getCachedContext = (SwsContext* @context, int @srcW, int @srcH, AVPixelFormat @srcFormat, int @dstW, int @dstH, AVPixelFormat @dstFormat, int @flags, SwsFilter* @srcFilter, SwsFilter* @dstFilter, double* @param) =>
        {
            ...
            vectors.sws_getCachedContext = sws_getCachedContext_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getCachedContext_delegate>(sws_getCachedContext_ptr);
        ...
        vectors.sws_getCoefficients = (int @colorspace) =>
        {
            ...
            vectors.sws_getCoefficients = sws_getCoefficients_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getCoefficients_delegate>(sws_getCoefficients_ptr);
        ...
        vectors.sws_getColorspaceDetails = (SwsContext* @c, int** @inv_table, int* @srcRange, int** @table, int* @dstRange, int* @brightness, int* @contrast, int* @saturation) =>
        {
            ...
            vectors.sws_getColorspaceDetails = sws_getColorspaceDetails_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getColorspaceDetails_delegate>(sws_getColorspaceDetails_ptr);
        ...
        vectors.sws_getContext = (int @srcW, int @srcH, AVPixelFormat @srcFormat, int @dstW, int @dstH, AVPixelFormat @dstFormat, int @flags, SwsFilter* @srcFilter, SwsFilter* @dstFilter, double* @param) =>
        {
            ...
            vectors.sws_getContext = sws_getContext_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getContext_delegate>(sws_getContext_ptr);
        ...
        vectors.sws_getDefaultFilter = (float @lumaGBlur, float @chromaGBlur, float @lumaSharpen, float @chromaSharpen, float @chromaHShift, float @chromaVShift, int @verbose) =>
        {
            ...
            vectors.sws_getDefaultFilter = sws_getDefaultFilter_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getDefaultFilter_delegate>(sws_getDefaultFilter_ptr);
        ...
        vectors.sws_getGaussianVec = (double @variance, double @quality) =>
        {
            ...
            vectors.sws_getGaussianVec = sws_getGaussianVec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_getGaussianVec_delegate>(sws_getGaussianVec_ptr);
        ...
        vectors.sws_init_context = (SwsContext* @sws_context, SwsFilter* @srcFilter, SwsFilter* @dstFilter) =>
        {
            ...
            vectors.sws_init_context = sws_init_context_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_init_context_delegate>(sws_init_context_ptr);
        ...
        vectors.sws_is_noop = (AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.sws_is_noop = sws_is_noop_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_is_noop_delegate>(sws_is_noop_ptr);
        ...
        vectors.sws_isSupportedEndiannessConversion = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.sws_isSupportedEndiannessConversion = sws_isSupportedEndiannessConversion_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_isSupportedEndiannessConversion_delegate>(sws_isSupportedEndiannessConversion_ptr);
        ...
        vectors.sws_isSupportedInput = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.sws_isSupportedInput = sws_isSupportedInput_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_isSupportedInput_delegate>(sws_isSupportedInput_ptr);
        ...
        vectors.sws_isSupportedOutput = (AVPixelFormat @pix_fmt) =>
        {
            ...
            vectors.sws_isSupportedOutput = sws_isSupportedOutput_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_isSupportedOutput_delegate>(sws_isSupportedOutput_ptr);
        ...
        vectors.sws_normalizeVec = (SwsVector* @a, double @height) =>
        {
            ...
            vectors.sws_normalizeVec = sws_normalizeVec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_normalizeVec_delegate>(sws_normalizeVec_ptr);
        ...
        vectors.sws_receive_slice = (SwsContext* @c, uint @slice_start, uint @slice_height) =>
        {
            ...
            vectors.sws_receive_slice = sws_receive_slice_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_receive_slice_delegate>(sws_receive_slice_ptr);
        ...
        vectors.sws_receive_slice_alignment = (SwsContext* @c) =>
        {
            ...
            vectors.sws_receive_slice_alignment = sws_receive_slice_alignment_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_receive_slice_alignment_delegate>(sws_receive_slice_alignment_ptr);
        ...
        vectors.sws_scale = (SwsContext* @c, byte*[] @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, byte*[] @dst, int[] @dstStride) =>
        {
            ...
            vectors.sws_scale = sws_scale_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_scale_delegate>(sws_scale_ptr);
        ...
        vectors.sws_scale_frame = (SwsContext* @c, AVFrame* @dst, AVFrame* @src) =>
        {
            ...
            vectors.sws_scale_frame = sws_scale_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_scale_frame_delegate>(sws_scale_frame_ptr);
        ...
        vectors.sws_scaleVec = (SwsVector* @a, double @scalar) =>
        {
            ...
            vectors.sws_scaleVec = sws_scaleVec_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_scaleVec_delegate>(sws_scaleVec_ptr);
        ...
        vectors.sws_send_slice = (SwsContext* @c, uint @slice_start, uint @slice_height) =>
        {
            ...
            vectors.sws_send_slice = sws_send_slice_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_send_slice_delegate>(sws_send_slice_ptr);
        ...
        vectors.sws_setColorspaceDetails = (SwsContext* @c, in int_array4 @inv_table, int @srcRange, in int_array4 @table, int @dstRange, int @brightness, int @contrast, int @saturation) =>
        {
            ...
            vectors.sws_setColorspaceDetails = sws_setColorspaceDetails_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_setColorspaceDetails_delegate>(sws_setColorspaceDetails_ptr);
        ...
        vectors.sws_test_colorspace = (AVColorSpace @colorspace, int @output) =>
        {
            ...
            vectors.sws_test_colorspace = sws_test_colorspace_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_test_colorspace_delegate>(sws_test_colorspace_ptr);
        ...
        vectors.sws_test_format = (AVPixelFormat @format, int @output) =>
        {
            ...
            vectors.sws_test_format = sws_test_format_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_test_format_delegate>(sws_test_format_ptr);
        ...
        vectors.sws_test_frame = (AVFrame* @frame, int @output) =>
        {
            ...
            vectors.sws_test_frame = sws_test_frame_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_test_frame_delegate>(sws_test_frame_ptr);
        ...
        vectors.sws_test_primaries = (AVColorPrimaries @primaries, int @output) =>
        {
            ...
            vectors.sws_test_primaries = sws_test_primaries_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_test_primaries_delegate>(sws_test_primaries_ptr);
        ...
        vectors.sws_test_transfer = (AVColorTransferCharacteristic @trc, int @output) =>
        {
            ...
            vectors.sws_test_transfer = sws_test_transfer_ptr == IntPtr.Zero ? delegate { throw new NotSupportedException(); } : Marshal.GetDelegateForFunctionPointer<vectors.sws_test_transfer_delegate>(sws_test_transfer_ptr);
